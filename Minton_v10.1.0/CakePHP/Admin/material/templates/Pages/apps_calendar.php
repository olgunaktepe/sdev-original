...
<head>
    <?= $this->element('title-meta', array('title' => 'Calendar')) ?>
    ...
    <link href="/libs/@fullcalendar/list/main.min.css" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Apps', 'title' => 'Calendar')) ?>
    ...
    <script src="/libs/@fullcalendar/list/main.min.js"></script>
