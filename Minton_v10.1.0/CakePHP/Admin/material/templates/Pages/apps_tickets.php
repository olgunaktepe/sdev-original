...
<head>
    <?= $this->element('title-meta', array('title' => 'Tickets')) ?>
...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Apps', 'title' => 'Tickets')) ?>
                                    ...
                                    <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" cellspacing="0" id="tickets-table">
                                        ...
                                        <tbody class="font-14">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);" class="text-dark">
                                                        <img src="/images/users/avatar-2.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);">
                                                        <img src="/images/users/avatar-10.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);" class="text-dark">
                                                        <img src="/images/users/avatar-3.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);">
                                                        <img src="/images/users/avatar-9.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);" class="text-dark">
                                                        <img src="/images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);" class="text-dark">
                                                        <img src="/images/users/avatar-8.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);">
                                                        <img src="/images/users/avatar-1.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);" class="text-dark">
                                                        <img src="/images/users/avatar-4.jpg" alt="contact-img" title="contact-img" class="avatar-sm rounded-circle img-thumbnail" />
    ...
    <script src="/js/pages/tickets.init.js"></script>
