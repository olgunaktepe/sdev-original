...
<head>
    <?= $this->element('title-meta', array('title' => 'Tour')) ?>
...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Extended UI', 'title' => 'Tour')) ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="/images/logo-dark.png" alt="" height="20" id="logo-tour">
                                    </div>
    ...
    <!-- Tour init js-->
    <script src="/js/pages/tour.init.js"></script>
