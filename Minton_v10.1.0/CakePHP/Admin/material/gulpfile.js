...
function styles() {
    ...
    src([`${paths.scss}/config/material/app.scss`, `${paths.scss}/config/material/bootstrap.scss`, `${paths.scss}/icons.scss`])
        .pipe(
            sass({
    ...
    // rtl css
    return src([`${paths.scss}/config/material/app.scss`, `${paths.scss}/config/material/bootstrap.scss`])
        .pipe(
            sass({
                importer: tildeImporter,
                includePaths: [paths.scss],
