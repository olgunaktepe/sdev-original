...
<head>
    <?= $this->element('title-meta', array('title' => 'Sitemap')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Extras', 'title' => 'Sitemap')) ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <ul class="sitemap">
                                                <li><a href="javascript: void(0);" class="text-uppercase fw-bold"><img src="/images/logo-sm-dark.png" alt="" height="12" class="me-1"> Minton Pages</a>
                                                    <ul>
                                                        <li><a href="javascript: void(0);"><i class="ri-dashboard-line me-1"></i>Dashboards</a>
                                                            <ul>
                                                        ...
                                                        <li><a href="javascript: void(0);"><i class="ri-layout-line me-1"></i>Layouts</a></li>
                                                        <li><a href="javascript: void(0);"><i class="fe-grid me-1"></i>Applications</a>
                                                            <ul>
                                                                <li><a href="javascript: void(0);">Chat</a></li>
                                                                <li><a href="javascript: void(0);">eCommerce</a>
                                                                    <ul>
                                                                        <li><a href="javascript: void(0);">Products List</a></li>
                                                                        <li><a href="javascript: void(0);">Products Grid</a></li>
                                                        ...
                                                        <li><a href="javascript: void(0);"><i class="ri-pages-line me-1"></i>Sitemap</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div> <!-- end col-->
                                        ...
                                        <div class="col-lg-4">
                                            <ul class="sitemap">
                                                <li><a href="javascript: void(0);" class="text-uppercase fw-bold"><img src="/images/logo-sm-dark.png" alt="" height="12" class="me-1"> Minton</a>
                                                    <ul>
