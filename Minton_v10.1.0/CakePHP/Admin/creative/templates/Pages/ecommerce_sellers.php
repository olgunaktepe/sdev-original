...
<head>
    <?= $this->element('title-meta', array('title' => 'Sellers')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'eCommerce', 'title' => 'Sellers')) ?>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="/images/users/avatar-3.jpg" alt="user-image" class="rounded avatar-md">
                                        </div>
                                        <div class="flex-1">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="/images/users/avatar-4.jpg" alt="user-image" class="rounded avatar-md">
                                        </div>
                                        <div class="flex-1">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            <img src="/images/users/avatar-5.jpg" alt="user-image" class="rounded avatar-md">
                                        </div>
                                        <div class="flex-1">
