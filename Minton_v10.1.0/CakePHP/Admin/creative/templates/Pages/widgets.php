...
<head>
    <?= $this->element('title-meta', array('title' => 'Widgets')) ?>
...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Components', 'title' => 'Widgets')) ?>

                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-simple text-center card">
                                <div class="card-body">
                                    <h3 class="text-success mt-0"><span data-plugin="counterup">2562</span></h3>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-simple text-center card">
                                <div class="card-body">
                                    <h3 class="text-primary mt-0"><span data-plugin="counterup">5685</span></h3>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-simple text-center card">
                                <div class="card-body">
                                    <h3 class="text-pink mt-0">$ <span data-plugin="counterup">12480</span></h3>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-simple text-center card">
                                <div class="card-body">
                                    <h3 class="text-purple mt-0"><span data-plugin="counterup">62</span></h3>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-success">
                                            <i class="mdi mdi-android-studio font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">64,570</span></h3>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-primary">
                                            <i class="mdi mdi-amazon font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">31,570</span></h3>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-danger">
                                            <i class="mdi mdi-apple font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-purple">
                                            <i class="mdi mdi-barley font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">0.16</span>%</h3>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-bg-color-icon card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-info">
                                            <i class="mdi mdi-black-mesa font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">23,570</span></h3>
                                            <p class="text-muted mb-0">Today's Visits</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-warning">
                                            <i class="mdi mdi-bullseye font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">9,654</span></h3>
                                            <p class="text-muted mb-0">Total Revenue</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-bg-color-icon card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-dark">
                                            <i class="mdi mdi-cart font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">965</span></h3>
                                            <p class="text-muted mb-0">Today's Sales</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="widget-bg-color-icon card">
                                <div class="card-body">
                                    <div class="d-flex align-items-start">
                                        <div class="avatar-lg rounded-circle bg-icon-pink">
                                            <i class="mdi mdi-clock font-24 avatar-title"></i>
                                        </div>
                                        <div class="flex-1 text-end align-self-center">
                                            <h3 class="mt-0"><span data-plugin="counterup">0.65</span>%</h3>
                                            <p class="text-muted mb-0">Conversion</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mt-0">New Customers</h4>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mt-0">Online Orders</h4>

                                    <div class="mt-3">
                                        <div class="d-flex align-items-start">
                                            <div dir="ltr">
                                                <input data-plugin="knob" data-width="64" data-height="64" data-fgColor="#675db7" data-bgColor="#e8e7f4" value="80" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                            </div>
                                            <div class="flex-1 text-end align-self-center">
                                                <h3 class="mt-0 mb-1"> 8715 </h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <div class="d-flex align-items-start">
                                            <div dir="ltr">
                                                <input data-plugin="knob" data-width="64" data-height="64" data-fgColor="#23b397" data-bgColor="#c8ece5" value="77" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                            </div>
                                            <div class="flex-1 text-end align-self-center">
                                                <h3 class="mt-0 mb-1"> $925 </h3>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mt-0">Daily Average</h4>

                                    <div class="mt-3">
                                        <div class="d-flex align-items-start">
                                            <div dir="ltr">
                                                <input data-plugin="knob" data-width="64" data-height="64" data-fgColor="#ffbd4a" data-bgColor="#FFE6BA" value="35" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                            </div>
                                            <div class="flex-1 text-end align-self-center">
                                                <h3 class="mt-0 mb-1"> $78.58 </h3>
                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div class="avatar-lg">
                                                <img src="/images/users/avatar-1.jpg" class="img-fluid rounded-circle" alt="user">
                                            </div>
                                        </div>
                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div class="avatar-lg">
                                                <img src="/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="user">
                                            </div>
                                        </div>
                                        <div class="col">
                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div class="avatar-lg">
                                                <img src="/images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="user">
                                            </div>
                                        </div>
                                        <div class="col">
                            ...
                            <div class="widget-rounded-circle card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <div class="avatar-lg">
                                                <img src="/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="user">
                                            </div>
                                        </div>
                                        <div class="col">
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="widget-chart text-center">
                                                <div id="sparkline5" data-colors="#3bafda" class="text-center"></div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="widget-chart text-center">
                                                <div id="sparkline6" data-colors="#f1556c,#1abc9c" class="text-center"></div>
                                                <div class="row mt-3">
                                                    <div class="col-4">
                                                        <p class="text-muted font-15 mb-1 text-truncate">Target</p>
                                                        <h4>$1022</h4>
                                            ...
                                            <div class="chat-conversation">
                                                ...
                                                <form class="needs-validation" novalidate name="chat-form" id="chat-form">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto">
                                                            <button type="submit" class="btn btn-primary chat-send width-sm waves-effect waves-light">Send</button>
                                                        </div>
                                                    </div>
                                                </form>
    ...
    <!-- Chat js -->
    <script src="/js/pages/jquery.chat.js"></script>

    <!-- TODO js-->
    <script src="/js/pages/jquery.todo.js"></script>

    <!-- Widgets demo js-->
    <script src="/js/pages/widgets.init.js"></script>
