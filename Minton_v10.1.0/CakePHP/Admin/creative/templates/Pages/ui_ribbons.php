...
<head>
    <?= $this->element('title-meta', array('title' => 'Ribbons')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Base UI', 'title' => 'Ribbons')) ?>

                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-purple float-start"><i class="mdi mdi-access-point me-1"></i> Purple</div>
                                    <h5 class="text-purple float-end mt-0">Purple Header</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-pink float-start ribbon-shape">Pink</div>
                        ...
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-secondary float-end ribbon-shape">Secondary</div>
                        ...
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-dark float-end ribbon-shape">Dark</div>
