...
<head>
    <?= $this->element('title-meta', array('title' => 'Create Product')) ?>
...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'eCommerce', 'title' => 'Create Product')) ?>
    ...
    <!-- Init js -->
    <script src="/js/pages/add-product.init.js"></script>
