...
<head>
    <?= $this->element('title-meta', array('title' => 'Tasks List')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Tasks', 'title' => 'Tasks List')) ?>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="custom-accordion">
                                                <div class="mt-4">
                                                    <h5 class="position-relative mb-0"><a href="#taskcollapse1" class="text-dark d-block" data-bs-toggle="collapse">Today Tasks <span class="text-muted">(08)</span> <i class="mdi mdi-chevron-down accordion-arrow"></i></a></h5>
                                                            ...
                                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-2.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Houston Fritz" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 10am</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-3.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Glenn Lynch" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 04pm</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-4.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Robert Hebert" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 02pm</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-5.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Darnell McCormick" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 06pm</td>
                                                ...
                                                <div class="mt-4">
                                                    <h5 class="position-relative mb-0"><a href="#taskcollapse2" class="text-dark d-block" data-bs-toggle="collapse">Upcoming Tasks <span class="text-muted">(05)</span> <i class="mdi mdi-chevron-down accordion-arrow"></i></a></h5>
                                                            ...
                                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-5.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Donald Mealy" />
                                                                            </div>
                                                                        </td>
                                                                        <td>May 27, 2020</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-6.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Shelton Garza" />
                                                                            </div>
                                                                        </td>
                                                                        <td>No Due Date</td>
                                                                        <td><span class="badge badge-soft-info p-1">Medium</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-7.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Adrian Key" />
                                                                            </div>
                                                                        </td>
                                                                        <td>June 08, 2020</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                ...
                                                <div class="mt-4">
                                                    <h5 class="position-relative mb-0"><a href="#taskcollapse3" class="text-dark d-block" data-bs-toggle="collapse">Other Tasks <span class="text-muted">(03)</span> <i class="mdi mdi-chevron-down accordion-arrow"></i></a></h5>
                                                            ...
                                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                                <thead class="table-light">
                                                                    <tr class="">
                                                                        <th scope="col">
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="checkbox" id="taskotherCheck">
                                                                                <label class="form-check-label" for="taskotherCheck">Task ID</label>
                                                                            </div>
                                                                        </th>
                                                                        <th scope="col">Tasks</th>
                                                                        <th scope="col">Assign to</th>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="checkbox" id="taskotherCheck01">
                                                                                <label class="form-check-label" for="taskotherCheck01">#MN2054</label>
                                                                            </div>
                                                                        </td>
                                                                        <td>Brand logo design</td>
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-9.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Donald Mealy" />
                                                                            </div>
                                                                        </td>
                                                                        <td>June 04, 2020</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="checkbox" id="taskotherCheck02">
                                                                                <label class="form-check-label" for="taskotherCheck02">#MN2053</label>
                                                                            </div>
                                                                        </td>
                                                                        <td>Improve animation loader</td>
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-10.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Doris Kinsey" />
                                                                            </div>
                                                                        </td>
                                                                        <td>June 10, 2020</td>
                                                                        <td><span class="badge badge-soft-info p-1">Medium</span></td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="checkbox" id="taskotherCheck03">
                                                                                <label class="form-check-label" for="taskotherCheck03">#MN2052</label>
                                                                            </div>
                                                                        </td>
                                                                        <td>Dashboard Re-design</td>
                                                                        <td>
                                                                            <div>
                                                                                <img src="/images/users/avatar-2.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Donnell Smith" />
                                                                            </div>
                                                                        </td>
                                                                        <td>No Due Date</td>
                                                                        <td><span class="badge badge-soft-success p-1">Low</span></td>
