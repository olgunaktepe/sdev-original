...
<head>
    <?= $this->element('title-meta', array('title' => 'Error Page | 404 | Page not Found')) ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <h3 class="mt-4 text-uppercase fw-bold">Page not found </h3>
                                ...
                                <a class="btn btn-primary mt-3" href="/"><i class="mdi mdi-reply me-1"></i> Return Home</a>
                            </div>
