                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            ...
                            <a href="/apps-calendar" class="dropdown-item"><i class="ri-calendar-2-line align-middle me-1"></i> Calendar</a>
                            <a href="/apps-chat" class="dropdown-item"><i class="ri-message-2-line align-middle me-1"></i> Chat</a>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                    <a href="ecommerce-products" class="dropdown-item">Products List</a>
                                    <a href="ecommerce-products-grid" class="dropdown-item">Products Grid</a>
                                    <a href="ecommerce-product-detail" class="dropdown-item">Product Detail</a>
                                    <a href="ecommerce-product-create" class="dropdown-item">Create Product</a>
                                    <a href="ecommerce-customers" class="dropdown-item">Customers</a>
                                    <a href="ecommerce-orders" class="dropdown-item">Orders</a>
                                    <a href="ecommerce-orders-detail" class="dropdown-item">Order Detail</a>
                                    <a href="ecommerce-sellers" class="dropdown-item">Sellers</a>
                            ...
                            <a href="/apps-companies" class="dropdown-item"><i class="ri-building-4-line align-middle me-1"></i> Companies</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-task">
                                    <a href="task-list" class="dropdown-item">List</a>
                                    <a href="task-details" class="dropdown-item">Details</a>
                                    <a href="task-kanban-board" class="dropdown-item">Kanban Board</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="contacts-list" class="dropdown-item">Members List</a>
                                    <a href="contacts-profile" class="dropdown-item">Profile</a>
                                </div>
                            </div>
                            <a href="/apps-file-manager" class="dropdown-item"><i class="ri-folders-line align-middle me-1"></i> File Manager</a>
                            <a href="/apps-tickets" class="dropdown-item"><i class="ri-customer-service-2-line align-middle me-1"></i> Tickets</a>
                        </div>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <a href="ui-video" class="dropdown-item">Embed Video</a>
                                        <a href="ui-general" class="dropdown-item">General UI</a>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div>
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <a href="ui-portlets" class="dropdown-item">Portlets</a>
                                        ...
                                        <a href="ui-tooltips-popovers" class="dropdown-item">Tooltips & Popovers</a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-extendedui">
                                    <a href="extended-nestable" class="dropdown-item">Nestable List</a>
                                    <a href="extended-range-slider" class="dropdown-item">Range Slider</a>
                                    <a href="extended-sweet-alert" class="dropdown-item">Sweet Alert</a>
                                    <a href="extended-tour" class="dropdown-item">Tour Page</a>
                                    <a href="extended-treeview" class="dropdown-item">Tree View</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="forms-elements" class="dropdown-item">General Elements</a>
                                    <a href="forms-advanced" class="dropdown-item">Advanced</a>
                                    <a href="forms-validation" class="dropdown-item">Validation</a>
                                    <a href="forms-pickers" class="dropdown-item">Pickers</a>
                                    <a href="forms-wizard" class="dropdown-item">Wizard</a>
                                    <a href="forms-masks" class="dropdown-item">Masks</a>
                                    <a href="forms-quilljs" class="dropdown-item">Quilljs Editor</a>
                                    <a href="forms-file-uploads" class="dropdown-item">File Uploads</a>
                                    <a href="forms-x-editable" class="dropdown-item">X Editable</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="charts-flot" class="dropdown-item">Flot Charts</a>
                                    <a href="charts-apex" class="dropdown-item">Apex Charts</a>
                                    <a href="charts-morris" class="dropdown-item">Morris Charts</a>
                                    <a href="charts-chartjs" class="dropdown-item">Chartjs Charts</a>
                                    <a href="charts-peity" class="dropdown-item">Peity Charts</a>
                                    <a href="charts-chartist" class="dropdown-item">Chartist Charts</a>
                                    <a href="charts-c3" class="dropdown-item">C3 Charts</a>
                                    <a href="charts-sparklines" class="dropdown-item">Sparklines Charts</a>
                                    <a href="charts-knob" class="dropdown-item">Jquery Knob Charts</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    ...
                                    <a href="tables-datatables" class="dropdown-item">Data Tables</a>
                                    ...
                                    <a href="tables-footables" class="dropdown-item">FooTable</a>
                                    <a href="tables-tablesaw" class="dropdown-item">Tablesaw Tables</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="icons-feather" class="dropdown-item">Feather</a>
                                    <a href="icons-remix" class="dropdown-item">Remix</a>
                                    <a href="icons-boxicons" class="dropdown-item">Boxicons</a>
                                    <a href="icons-mdi" class="dropdown-item">Material Design</a>
                                    <a href="icons-font-awesome" class="dropdown-item">Font Awesome 5</a>
                                    <a href="icons-weather" class="dropdown-item">Weather</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-map">
                                    ...
                                    <a href="maps-mapael" class="dropdown-item">Mapael Maps</a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layout">
                            <a href="layouts-vertical" target="_blank" class="dropdown-item">Vertical</a>
                            <a href="layouts-horizontal" target="_blank" class="dropdown-item">Horizontal</a>
                            <a href="layouts-detached" target="_blank" class="dropdown-item">Detached</a>
                            <a href="index" target="_blank" class="dropdown-item">Two Column Menu</a>
                            <a href="layouts-preloader" target="_blank" class="dropdown-item">Preloader</a>
                        </div>
                    </li>
                </ul> <!-- end navbar-->
            </div> <!-- end .collapsed-->
