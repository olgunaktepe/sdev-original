            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarLayouts">
                        <ul class="nav-second-level">
                            <li>
                                <a href="layouts-vertical" target="_blank">Vertical</a>
                            </li>
                            <li>
                                <a href="layouts-horizontal" target="_blank">Horizontal</a>
                            </li>
                            <li>
                                <a href="layouts-detached" target="_blank">Detached</a>
                            </li>
                            <li>
                                <a href="index" target="_blank">Two Column Menu</a>
                            </li>
                            <li>
                                <a href="layouts-preloader" target="_blank">Preloader</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarCharts">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="charts-c3">C3</a>
                            </li>
                            <li>
                                <a href="charts-peity">Peity</a>
                            </li>
                            <li>
                                <a href="charts-chartist">Chartist</a>
                            </li>
                            <li>
                                <a href="charts-sparklines">Sparklines</a>
                            </li>
                            <li>
                                <a href="charts-knob">Jquery Knob</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarMaps">
                        <ul class="nav-second-level">
                            <li>
                                <a href="maps-google">Google</a>
                            </li>
                            <li>
                                <a href="maps-vector">Vector</a>
                            </li>
                            <li>
                                <a href="maps-mapael">Mapael</a>
                            </li>
                        </ul>
                    </div>
                </li>
