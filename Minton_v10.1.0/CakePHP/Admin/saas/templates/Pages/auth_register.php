...
<head>
    <?= $this->element("title-meta", array('title' => 'Register & Signup')) ?>
                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-muted">Already have account? <a href="auth-login" class="text-primary fw--medium ms-1">Sign In</a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
