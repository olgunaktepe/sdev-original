...
<head>
    <?= $this->element('title-meta', array('title' => 'Preloader')) ?>
...
<body>
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="/images/users/avatar-2.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="/images/users/avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="/images/users/avatar-4.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="/images/users/avatar-5.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                                    <span class="badge badge-soft-warning float-end">Cold lead</span>
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="/images/users/avatar-1.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                                    <span class="badge badge-soft-warning float-end">Cold lead</span>
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="/images/users/avatar-6.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                                    <span class="badge badge-soft-success float-end">Won lead</span>
    ...
    <!-- Dashboard init-->
    <script src="/js/pages/dashboard-crm.init.js"></script>
