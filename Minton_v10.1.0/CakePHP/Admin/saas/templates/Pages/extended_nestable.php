...
<head>
    <?= $this->element('title-meta', array('title' => 'Nestable List')) ?>

    <!-- nestable css -->
    <link href="/libs/nestable2/jquery.nestable.min.css" rel="stylesheet" />
...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Extended UI', 'title' => 'Nestable List')) ?>
    ...
    <!-- nestable2 js-->
    <script src="/libs/nestable2/jquery.nestable.min.js"></script>

    <!-- Nestable init-->
    <script src="/js/pages/nestable.init.js"></script>
