...
<head>
    <?= $this->element('title-meta', array('title' => 'Search Results')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Extras', 'title' => 'Search Results')) ?>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-8 offset-md-2">
                                            <div class="pt-3 pb-4">
                                                <div class="input-group">
                                                    ...
                                                    <button type="button" class="btn waves-effect waves-light btn-purple"><i class="fa fa-search me-1"></i> Search</button>
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="search-item">
                                                        ...
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://coderthemes.com/ubold/index
                                                        </div>
                                                    ...
                                                    <div class="search-item">
                                                        <h4 class="mb-1"><a href="#">Starto - Bootstrap 5 Landing Page Template</a></h4>
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://coderthemes.com/starto/index-demo
                                                        </div>
                                                        <p class="mb-0 text-muted">
                                                            Dolor posuere proin blandit accumsan senectus netus nullam curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum, tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.
                                                        </p>
                                                    ...
                                                    <div class="search-item">
                                                        <div class="d-flex">
                                                            <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-1.jpg" alt="Generic placeholder image" height="54">
                                                            <div class="flex-1">
                                                                <h5 class="mt-0">
                                                    ...
                                                    <div class="search-item">
                                                        <h4 class="mb-1"><a href="#">Ubold - Admin & Dashboard Template</a></h4>
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://coderthemes.com/ubold/index
                                                        </div>
                                                        <p class="mb-0 text-muted">
                                                    ...
                                                    <div class="search-item">
                                                        <h4 class="mb-1"><a href="#">Ubold - Bootstrap 5 Admin & Frontend</a></h4>
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://wrapbootstrap.com/user/coderthemes?ref=coderthemes
                                                        </div>
                                                    ...
                                                    <div class="search-item">
                                                        <h4 class="mb-1"><a href="#">Coderthemes - WrapBootstrap</a></h4>
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://wrapbootstrap.com/user/coderthemes?ref=coderthemes
                                                        </div>
                                                        <p class="mb-0 text-muted">
                                        ...
                                        <div class="tab-pane" id="users">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-2.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-3.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-4.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="/images/users/avatar-5.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
