<!DOCTYPE html>
<html lang="en" data-layout-mode="two-column" data-two-column-color="brand">

<head>
    <?= $this->element('title-meta', array('title' => 'Two Column Layout')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Layouts', 'title' => 'Two Column')) ?>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            ...
                            <div class="card">
                                <div class="card-body" id="tooltip-container">
                                    ...
                                    <p class="text-muted m-0">Since last month: 22506 <span class="float-end"><i class="mdi mdi-arrow-up-bold me-1 text-success"></i>10.25%</span></p>
                            ...
                            <div class="card">
                                <div class="card-body" id="tooltip-container1">
                                    ...
                                    <p class="text-muted m-0">Since previous week: 8541 <span class="float-end"><i class="mdi mdi-arrow-down-bold me-1 text-danger"></i>2.63%</span></p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-8">
                                            <div id="usa-vectormap" style="height: 363px" data-colors="#3bafda"></div>
                                        </div> <!-- end col -->
                                        <div class="col-xl-4">
                                            <h5 class="mb-1 mt-0">1,12,540 <small class="text-muted ms-2">www.getbootstrap.com</small></h5>
                                            <div class="row align-items-center g-0 mb-2 pb-1">
                                                ...
                                                <div class="col-auto">
                                                    <div class="fw-medium ms-2">72%</div>
                                                </div>
                                            </div>

                                            <h5 class="mb-1 mt-0">51,480 <small class="text-muted ms-2">www.youtube.com</small></h5>
                                            <div class="row align-items-center g-0 mb-2 pb-1">
                                                <div class="col">
                                                    <div class="progress progress-sm">
                                                ...
                                                <div class="col-auto">
                                                    <div class="fw-medium ms-2">65%</div>
                                                </div>
                                            </div>

                                            <h5 class="mb-1 mt-0">45,760 <small class="text-muted ms-2">www.dribbble.com</small></h5>
                                            <div class="row align-items-center g-0 mb-2 pb-1">
                                                <div class="col">
                                                    <div class="progress progress-sm">
                                                ...
                                                <div class="col-auto">
                                                    <div class="fw-medium ms-2">48%</div>
                                                </div>
                                            </div>

                                            <h5 class="mb-1 mt-0">98,512 <small class="text-muted ms-2">www.behance.net</small></h5>
                                            <div class="row align-items-center g-0 mb-2 pb-1">
                                                <div class="col">
                                                    <div class="progress progress-sm">
                                                ...
                                                <div class="col-auto">
                                                    <div class="fw-medium ms-2">59%</div>
                                                </div>
                                            </div>

                                            <h5 class="mb-1 mt-0">2,154 <small class="text-muted ms-2">www.vimeo.com</small></h5>
                                            <div class="row align-items-center g-0">
                                                ...
                                                <div class="col-auto">
                                                    <div class="fw-medium ms-2">21%</div>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive browser_users">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><i class="fab fa-chrome me-2 text-success font-16"></i>Chrome</td>
                                                    <td>10853 <small class="text-muted">(52%)</small></td>
                                                    <td> 52.80%</td>
                                                    <td>566 <small class="text-muted">(92%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><i class="fab fa-safari me-2 text-info font-16"></i>Safari</td>
                                                    <td>2545 <small class="text-muted">(47%)</small></td>
                                                    <td> 47.54%</td>
                                                    <td>498 <small class="text-muted">(81%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><i class="fab fa-internet-explorer me-2 text-warning font-16"></i>Internet-Explorer</td>
                                                    <td>1836 <small class="text-muted">(38%)</small></td>
                                                    <td> 41.12%</td>
                                                    <td>455 <small class="text-muted">(74%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><i class="fab fa-opera me-2 text-danger font-16"></i>Opera</td>
                                                    <td>1958 <small class="text-muted">(31%)</small></td>
                                                    <td> 36.82%</td>
                                                    <td>361 <small class="text-muted">(61%)</small></td>
                                                </tr><!--end tr-->
                                                <tr>
                                                    <td><i class="fab fa-firefox me-2 text-blue font-16"></i>Firefox</td>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <a href="" class="p-0 float-end mb-3">Export <i class="mdi mdi-download ms-1"></i></a>
