...
<head>
    <?= $this->element('title-meta', array('title' => 'Scrollspy')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Extended UI', 'title' => 'Scrollspy')) ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="sub-header">Scroll the area below the navbar and watch the active
                                    ...
                                    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example">
                                        ...
                                        <div>
                                            <h4 id="fat" class="pt-2 mt-0">@fat</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="sub-header">Scrollspy also works with nested <code>.nav</code>s.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-offset="0" class="scrollspy-example" style="height: 350px;">
                                                <div>
                                                    <h4 id="item-1" class="pt-2 mt-0">Item 1</h4>
