...
<head>
    <?= $this->element('title-meta', array('title' => 'Avatars')) ?>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'Base UI', 'title' => 'Avatars')) ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md col-sm-6">
                                            <div class="mt-3">
                                                <img src="/images/users/avatar-3.jpg" alt="image" class="img-fluid avatar-sm rounded">
                                                <p class="mb-0">
                                                    <code>.avatar-sm</code>
                                                </p>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md col-sm-6">
                                            <div class="mt-3">
                                                <img src="/images/users/avatar-6.jpg" alt="image" class="img-fluid avatar-xs rounded-circle" />
                                                <p class="mb-0">
                                                    <code>.avatar-xs .rounded-circle</code>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md col-sm-6">
                                            <div class="mt-3">
                                                <img src="/images/users/avatar-5.jpg" alt="image" class="img-fluid avatar-sm rounded-circle" />
                                                <p class="mb-0">
                                                    <code>.avatar-sm .rounded-circle</code>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md col-sm-6">
