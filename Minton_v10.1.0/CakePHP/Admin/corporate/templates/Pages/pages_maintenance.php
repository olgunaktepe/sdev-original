...
<head>
    <?= $this->element('title-meta', array('title' => 'Maintenance')) ?>
            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    ...
                    <div class="text-center">
                        <img src="/images/animat-diamond-color.gif" alt="" height="160">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-4">
                                <div class="text-center mt-3 px-1">
                                    ...
                                    <p class="text-muted">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embar.. <a href="mailto:#" class="text-muted fw-medium">no-reply@domain.com</a></p>
                                </div>
                            </div> <!-- end col-->
                        </div> <!-- end row-->
                    </div> <!-- end /.text-center-->
