        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?= $this->element('page-title', array('subTitle' => 'eCommerce', 'title' => 'Checkout')) ?>
                                                ...
                                                <div class="tab-content twitter-bs-wizard-tab-content">
                                                    <div class="tab-pane" id="billing-info">
                                                        ...
                                                        <ul class="pager wizard list-inline mt-2">
                                                            <li class="list-inline-item">
                                                                <a href="ecommerce-cart" class="btn btn-secondary"><i class="mdi mdi-arrow-left"></i> Back to Shopping Cart </a>
                                                            </li>
                                                    ...
                                                    <div class="tab-pane" id="shipping-info">
                                                        ...
                                                        <ul class="pager wizard list-inline mt-3">
                                                            ...
                                                            <li class="next list-inline-item float-end">
                                                                <button type="button" class="btn btn-success"><i class="mdi mdi-cash-multiple me-1"></i> Continue to Payment </button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                        ...
                                                        <table class="table table-centered table-nowrap mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail" class="text-body fw-semibold">Blue color T-shirt</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail" class="text-body fw-semibold">Blue Hoodie for men</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail" class="text-body fw-semibold">Full sleeve Pink T-shirt</a>
