...
<head>
    <?php
    $title = "Contacts & Members Listing";
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php $page_title = "Contacts & Members Listing";
                    $sub_title = "Contacts";
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Denver Barker</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Robert McBride</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/users/avatar-4.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Peter White</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/users/avatar-5.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Ronald Myrick</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/users/avatar-6.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Paul Halpern</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/users/avatar-7.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Ricky Atwell</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">James Richards</a></h4>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="text-center card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/users/avatar-8.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                                    <h4 class="mt-3 mb-1"><a href="contacts-profile.php" class="text-dark">Charles Martinez</a></h4>
