                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="avatar-sm">
                                            <span class="avatar-title bg-soft-success rounded">
                                                <i class="ri-stack-line font-20 text-success"></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="avatar-sm">
                                            <span class="avatar-title bg-soft-danger rounded">
                                                <i class="ri-hand-heart-line font-20 text-danger"></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="avatar-sm">
                                            <span class="avatar-title bg-soft-warning rounded">
                                                <i class="ri-money-dollar-box-line font-20 text-warning"></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3" dir="ltr">
                                        <div id="campaigns-chart" class="apex-charts" data-colors="#48c2e7,#18c984,#526dee"></div>
                                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3" dir="ltr">
                                        <div id="revenue-chart" class="apex-charts" data-colors="#6559cc,#ced4dc"></div>
                                    </div>
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
                        </div> <!-- end col -->
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="assets/images/users/avatar-2.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="assets/images/users/avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="assets/images/users/avatar-4.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="assets/images/users/avatar-5.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                                    <span class="badge badge-soft-warning float-end">Cold lead</span>
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="assets/images/users/avatar-1.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                                    <span class="badge badge-soft-warning float-end">Cold lead</span>
                                            ...
                                            <div class="d-flex mt-3">
                                                <img class="avatar-sm align-self-center me-3 rounded-circle" src="assets/images/users/avatar-6.jpg" alt="Generic placeholder image">
                                                <div class="flex-1">
                                                    <span class="badge badge-soft-success float-end">Won lead</span>
                                                ...
                                                <form name="todo-form" id="todo-form" class="needs-validation mt-3" novalidate>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto d-grid">
                                                            <button class="btn btn-primary btn-md-block width-sm waves-effect waves-light" type="submit" id="todo-btn-submit">Add</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div> <!-- end .todoapp-->
