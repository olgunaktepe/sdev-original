                        ...
                        <div class="col-lg-6">
                            <div class="card" dir="ltr">
                                <div class="card-body">
                                    ...
                                    <div id="morris-bar-stacked" style="height: 350px;" class="morris-chart" data-colors="#18c984,#526dee,#e3eaef"></div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col-->
                        ...
                        <div class="col-lg-6">
                            <div class="card" dir="ltr">
                                <div class="card-body">
                                    ...
                                    <div id="morris-area-example" style="height: 350px;" class="morris-chart" data-colors="#18c984,#ebeff2"></div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col-->
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card" dir="ltr">
                                <div class="card-body">
                                    ...
                                    <div id="morris-line-example" style="height: 350px;" class="morris-chart" data-colors="#18c984,#526dee"></div>
                                </div>
                            </div> <!-- card -->
                        </div> <!-- end row -->
                        ...
                        <div class="col-lg-6">
                            <div class="card" dir="ltr">
                                <div class="card-body">
                                    ...
                                    <div id="morris-bar-example" style="height: 350px;" class="morris-chart" data-colors="#18c984,#526dee,#ebeff2"></div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col-->
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card" dir="ltr">
                                <div class="card-body">
                                    ...
                                    <div id="morris-area-with-dotted" style="height: 350px;" class="morris-chart" data-colors="#e3eaef,#526dee"></div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col-->
                        ...
                        <div class="col-lg-6">
                            <div class="card" dir="ltr">
                                <div class="card-body">
                                    ...
                                    <div id="morris-donut-example" style="height: 350px;" class="morris-chart" data-colors="#526dee,#18c984,#ebeff2"></div>
                                    <div class="text-center">
                                        <p class="text-muted font-15 font-family-secondary mb-0">
                                            <span class="mx-2"><i class="mdi mdi-checkbox-blank-circle text-primary"></i> Bitcoin</span>
