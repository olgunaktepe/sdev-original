                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <div id="sparkline1" data-colors="#526dee,#18c984"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <div id="sparkline3" data-colors="#e3eaef,#526dee,#18c984,#f1556c" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <div id="sparkline4" data-colors="#f672a7,#526dee" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <div id="sparkline5" data-colors="#18c984" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-4">
                                        <div id="sparkline6" data-colors="#e3eaef,#18c984" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-4" style="min-height: 164px;">
                                        <div id="sparkline8" data-colors="#526dee,#5553ce" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-4" style="min-height: 164px;">
                                        <div id="sparkline9" data-colors="#526dee,#18c984" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-4" style="min-height: 164px;">
                                        <div id="sparkline10" data-colors="#18c984,#e3eaef,#f1556c" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
