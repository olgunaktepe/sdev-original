<!DOCTYPE html>
<html lang="en" data-layout-mode="two-column" data-two-column-color="brand" data-topbar-color="light">
...
<body>
    ...
    <div id="wrapper">
        ...
        <?php include 'partials/two-column-sidebar.php'; ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-8">
                                            <div id="usa-vectormap" style="height: 363px" data-colors="#0056c1"></div>
                                        </div> <!-- end col -->
                                        <div class="col-xl-4">
