                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <div>
                                                        ...
                                                        <a href="javascript: void(0);">
                                                            <img src="assets/images/users/avatar-3.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Jan 16, 2020</p>
                                                    </div>
                                                </div>

                                            </div>
                                        </li>
                                        <li id="task2" class="task-low">
                                            <div class="form-check mb-2 float-end">
                                                <input class="form-check-input ms-0" type="checkbox" value="">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-2.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Jan 22, 2020</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li id="task3" class="task-low">
                                            <div class="form-check mb-2 float-end">
                                                <input class="form-check-input ms-0" type="checkbox" value="">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-5.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Feb 08, 2020</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="task-high" id="task4">
                                            <div class="form-check mb-2 float-end">
                                                <input class="form-check-input ms-0" type="checkbox" value="">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-6.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-7.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Feb 12, 2020</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <div class="d-grid">
                                        <a href="javascript: void(0);" class="btn btn-primary mt-3 waves-effect waves-light"><i class="mdi mdi-plus-circle"></i> Add New</a>
                                    </div>
                                </div>
                                    ...
                                    <ul class="sortable-list tasklist list-unstyled" id="inprogress">
                                        ...
                                        <li class="task-low" id="task7">
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-8.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-4.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Jan 31, 2020</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="task-high" id="task8">
                                            <div class="form-check mb-2 float-end">
                                                <input class="form-check-input ms-0" type="checkbox" value="">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <a href="javascript: void(0);" class="text-muted">
                                                        <img src="assets/images/users/avatar-9.jpg" alt="task-user" class="avatar-sm img-thumbnail rounded-circle">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Mar 27, 2020</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="sortable-list tasklist list-unstyled" id="completed">
                                        ...
                                        <li class="task-medium" id="task11">
                                            <div class="form-check mb-2 float-end">
                                                <input class="form-check-input ms-0" type="checkbox" value="">
                                            </div>
                                        ...
                                        <li id="task12" class="task-low">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Apr 19, 2019</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="task-low" id="task13">
                                            <div class="form-check mb-2 float-end">
                                                <input class="form-check-input ms-0" type="checkbox" value="">
                                            </div>
                                            <h5 class="mt-0"><a href="javascript: void(0);" class="text-dark">iOS App home page</a></h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="text-end">
                                                        <p class="font-13 mt-2 mb-0"><i class="mdi mdi-calendar"></i> Apr 27, 2020</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
