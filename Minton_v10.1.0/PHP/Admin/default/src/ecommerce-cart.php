                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div>
                                                <div class="table-responsive">
                                                    <table class="table table-centered mb-0 table-nowrap">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <img src="assets/images/products/product-1.png" alt="product-img" title="product-img" class="avatar-lg" />
                                                                </td>
                                                                <td>
                                                                    <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">Blue color T-shirt</a></h5>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="assets/images/products/product-2.png" alt="product-img" title="product-img" class="avatar-lg" />
                                                                </td>
                                                                <td>
                                                                    <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">Half sleeve maroon T-shirt</a></h5>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="assets/images/products/product-6.png" alt="product-img" title="product-img" class="avatar-lg" />
                                                                </td>
                                                                <td>
                                                                    <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">Blue Hoodie for men</a></h5>
                                                                    <p class="mb-0">Size : <span class="fw-medium">Large</span></p>
                                                                </td>
                                                                <td>
                                                                    $ 45
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="assets/images/products/product-8.png" alt="product-img" title="product-img" class="avatar-lg" />
                                                                </td>
                                                                <td>
                                                                    <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">Full sleeve Pink T-shirt</a></h5>
                                                                    <p class="mb-0">Size : <span class="fw-medium">medium</span></p>
                                                                </td>
                                                                <td>
                                                                    $ 45
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-sm-6">
                                                        <a href="ecommerce-products.php" class="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">
