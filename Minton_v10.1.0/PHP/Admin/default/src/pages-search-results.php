                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="search-item">
                                                        ...
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://coderthemes.com/ubold/index.php
                                                        </div>
                                                    ...
                                                    <div class="search-item">
                                                        ...
                                                        <div class="font-13 text-success mb-2 text-truncate">
                                                            https://coderthemes.com/starto/index-demo.php
                                                        </div>
                                                        <p class="mb-0 text-muted">
                                                            Dolor posuere proin blandit accumsan senectus netus nullam curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum, tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.
                                                        </p>
                                                    ...
                                                    <div class="search-item">
                                                        <div class="d-flex">
                                                            <img class="d-flex me-3 rounded-circle" src="assets/images/users/avatar-1.jpg" alt="Generic placeholder image" height="54">
                                                            <div class="flex-1">
                                                                <h5 class="mt-0">
                                        ...
                                        <div class="tab-pane" id="users">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="assets/images/users/avatar-2.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="assets/images/users/avatar-3.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="assets/images/users/avatar-4.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
                                            ...
                                            <div class="search-item">
                                                <div class="d-flex align-self-start">
                                                    <img class="d-flex me-3 rounded-circle" src="assets/images/users/avatar-5.jpg" alt="Generic placeholder image" height="54">
                                                    <div class="flex-1">
                                                        <h5 class="mt-0">
