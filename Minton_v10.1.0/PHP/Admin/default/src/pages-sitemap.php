                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <ul class="sitemap">
                                                <li><a href="javascript: void(0);" class="text-uppercase fw-bold"><img src="assets/images/logo-sm-dark.png" alt="" height="12" class="me-1"> Minton Pages</a>
                                                    <ul>
                                        ...
                                        <div class="col-lg-4">
                                            <ul class="sitemap">
                                                <li><a href="javascript: void(0);" class="text-uppercase fw-bold"><img src="assets/images/logo-sm-dark.png" alt="" height="12" class="me-1"> Minton</a>
                                                    <ul>
