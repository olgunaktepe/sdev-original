                                                            ...
                                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-3.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Glenn Lynch" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 04pm</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-4.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Robert Hebert" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 02pm</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-5.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Darnell McCormick" />
                                                                            </div>
                                                                        </td>
                                                                        <td>Today 06pm</td>
                                                            ...
                                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-5.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Donald Mealy" />
                                                                            </div>
                                                                        </td>
                                                                        <td>May 27, 2020</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-6.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Shelton Garza" />
                                                                            </div>
                                                                        </td>
                                                                        <td>No Due Date</td>
                                                                        <td><span class="badge badge-soft-info p-1">Medium</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-7.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Adrian Key" />
                                                                            </div>
                                                                        </td>
                                                                        <td>June 08, 2020</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                            ...
                                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-9.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Donald Mealy" />
                                                                            </div>
                                                                        </td>
                                                                        <td>June 04, 2020</td>
                                                                        <td><span class="badge badge-soft-danger p-1">High</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-10.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Doris Kinsey" />
                                                                            </div>
                                                                        </td>
                                                                        <td>June 10, 2020</td>
                                                                        <td><span class="badge badge-soft-info p-1">Medium</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <img src="assets/images/users/avatar-2.jpg" alt="image" class="avatar-sm img-thumbnail rounded-circle" title="Donnell Smith" />
                                                                            </div>
                                                                        </td>
                                                                        <td>No Due Date</td>
                                                                        <td><span class="badge badge-soft-success p-1">Low</span></td>
