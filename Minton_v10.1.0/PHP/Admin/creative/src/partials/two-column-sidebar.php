                ...
                <div id="two-col-menu" class="h-100" data-simplebar>
                    ...
                    <div class="twocolumn-menu-item" id="layouts">
                        <div class="title-box">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="layouts-vertical.php">Vertical</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index.php">Horizontal</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="layouts-detached.php">Detached</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="layouts-two-column.php">Two Column Menu</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="layouts-preloader.php">Preloader</a>
                                </li>
                            </ul>
                        </div>
                    </div>
