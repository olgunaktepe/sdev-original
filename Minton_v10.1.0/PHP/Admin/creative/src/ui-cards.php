                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="assets/images/small/img-4.jpg" alt="Card image" class="img-fluid" />
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="assets/images/small/img-5.jpg" alt="Card image" class="img-fluid" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <div class="row row-cols-1 row-cols-md-3 g-3">
                                <div class="col">
                                    <div class="card">
                                        <img src="assets/images/small/img-4.jpg" class="card-img-top" alt="Card image" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
