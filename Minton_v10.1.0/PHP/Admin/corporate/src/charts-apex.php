                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase1" class="collapse pt-3 show" dir="ltr">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div id="spark1" class="apex-charts" data-colors="#f06b78"></div>
                                            </div>
                                            <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase2" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-line-1" class="apex-charts" data-colors="#f06b78,#1abc9c"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase4" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-area" class="apex-charts" data-colors="#f06b78,#1abc9c,#CED4DC"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase5" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-column-1" class="apex-charts" data-colors="#f06b78,#1abc9c,#CED4DC"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase6" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-column-2" class="apex-charts" data-colors="#f06b78"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase7" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-mixed-1" class="apex-charts" data-colors="#CED4DC,#f06b78"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase9" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-bar-2" class="apex-charts" data-colors="#f06b78,#1abc9c"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase10" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-mixed-2" class="apex-charts" data-colors="#f06b78,#1abc9c,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase11" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-mixed-3" class="apex-charts" data-colors="#f06b78,#ebf2f6,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase12" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-bubble-1" class="apex-charts" data-colors="#f06b78,#1abc9c,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase13" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-bubble-2" class="apex-charts" data-colors="#f06b78,#1abc9c,#6c757d,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase15" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-scatter-2" class="apex-charts" data-colors="#f06b78,#1abc9c,#f672a7,#6c757d,#6c757d"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase16" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-candlestick-1" class="apex-charts" data-colors="#f06b78,#1abc9c"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase17" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-candlestick-2" class="apex-charts" data-colors="#f06b78,#f7b84b"></div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase18" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-pie-1" class="apex-charts" data-colors="#f06b78,#1abc9c,#f7b84b,#6c757d,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase19" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-pie-2" class="apex-charts" data-colors="#f06b78,#1abc9c,#f7b84b,#6c757d,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase20" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-pie-3" class="apex-charts" data-colors="#f06b78,#1abc9c,#f7b84b,#6c757d,#f672a7"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase21" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-radialbar-1" class="apex-charts" data-colors="#f06b78"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="cardCollpase22" class="collapse pt-3 show" dir="ltr">
                                        <div id="apex-radialbar-2" class="apex-charts" data-colors="#f06b78,#f672a7,#1abc9c,#f7b84b"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
