...
<body>
                                    ...
                                    <div class="inbox-rightbar">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex align-items-start mb-3 mt-1">
                                                <img class="me-2 rounded-circle" src="assets/images/users/avatar-2.jpg" alt="placeholder image" height="32">
                                                <div class="flex-1">
    ...
    <script src="assets/js/pages/email.init.js"></script>
