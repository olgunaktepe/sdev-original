                                                    ...
                                                    <div class="tab-pane" id="billing-info">
                                                        ...
                                                        <ul class="pager wizard list-inline mt-2">
                                                            <li class="list-inline-item">
                                                                <a href="ecommerce-cart.php" class="btn btn-secondary"><i class="mdi mdi-arrow-left"></i> Back to Shopping Cart </a>
                                                            </li>
                                                        ...
                                                        <table class="table table-centered table-nowrap mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail.php" class="text-body fw-semibold">Blue color T-shirt</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail.php" class="text-body fw-semibold">Blue Hoodie for men</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail.php" class="text-body fw-semibold">Full sleeve Pink T-shirt</a>
