                                    ...
                                    <div class="d-flex align-items-start align-items-start mb-3">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-15">
                                                <a href="contacts-profile.php" class="text-reset">Nik Patel</a>
                                            </h5>
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start p-2">
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <p class="mt-1 mb-0 text-muted font-14">
                                                                <span class="w-25 float-end text-end"><span class="badge badge-soft-primary">3</span></span>
                                                ...
                                                <a href="javascript:void(0);" class="text-body">
                                                    <div class="d-flex align-items-start p-2">
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <p class="mt-1 mb-0 text-muted font-14">
                                                                <span class="w-25 float-end text-end"><span class="badge badge-soft-primary">2</span></span>
                            ...
                            <div class="card">
                                <div class="card-body py-2 px-3 border-bottom border-light">
                                    <div class="d-flex py-1">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-15">
                                                <a href="contacts-profile.php" class="text-reset">James Zavel</a>
                                            </h5>
