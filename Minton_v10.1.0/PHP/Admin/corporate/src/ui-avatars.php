                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md col-sm-6">
                                            <div class="mt-3">
                                                <img src="assets/images/users/avatar-3.jpg" alt="image" class="img-fluid avatar-sm rounded">
                                                <p class="mb-0">
                                                    <code>.avatar-sm</code>
                                                </p>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md col-sm-6">
                                            <div class="mt-3">
                                                <img src="assets/images/users/avatar-6.jpg" alt="image" class="img-fluid avatar-xs rounded-circle" />
                                                <p class="mb-0">
                                        ...
                                        <div class="col-md col-sm-6">
                                            <div class="mt-3">
                                                <img src="assets/images/users/avatar-5.jpg" alt="image" class="img-fluid avatar-sm rounded-circle" />
                                                <p class="mb-0">
