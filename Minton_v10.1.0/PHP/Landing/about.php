...
<body data-bs-target=".sticky" data-bs-offset="70">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ms-auto navbar-center" id="mySidenav">
                        ...
                        <li class="nav-item">
                            <a href="index.phptestimonial" class="nav-link">Testimonial</a>
                        </li>
                        <li class="nav-item">
                            <a href="index.php#faq" class="nav-link">FAQs</a>
                        </li>
                        <li class="nav-item">
                            <div class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <h3 class="page-header-title text-white text-uppercase mb-0">About us</h3>
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="mo-mb-20">
                        <h4 class="mb-4">We are a full-stack web design and development studio</h4>
                        ...
                        <div class="text-muted">
                            <p><i class="mdi mdi-check text-primary me-2"></i> Sed ut perspiciatis unde omnis iste</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> Et harum quidem rerum facilis est et</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> Itaque earum rerum hic tenetur a sapiente</p>
                        </div>
                        <div class="pt-4">
                            <a href="#" class="btn btn-purple">Check Out Works <i class="mdi mdi-arrow-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="about-box card">
                        <div class="p-4">
                            <div class="clearfix mb-2">
                                <h4 class="float-start me-3 text-primary about-index-number mt-0">01</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="about-box card">
                        <div class="p-4">
                            <div class="clearfix mb-2">
                                <h4 class="float-start me-3 text-primary about-index-number mt-0">02</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="about-box card">
                        <div class="p-4">
                            <div class="clearfix mb-2">
                                <h4 class="float-start me-3 text-primary about-index-number mt-0">03</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="about-box card">
                        <div class="p-4">
                            <div class="clearfix mb-2">
                                <h4 class="float-start me-3 text-primary about-index-number mt-0">04</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="about-box card">
                        <div class="p-4">
                            <div class="clearfix mb-2">
                                <h4 class="float-start me-3 text-primary about-index-number mt-0">05</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="about-box card">
                        <div class="p-4">
                            <div class="clearfix mb-2">
                                <h4 class="float-start me-3 text-primary about-index-number mt-0">06</h3>
