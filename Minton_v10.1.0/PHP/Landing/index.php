...
<body data-bs-spy="scroll" data-bs-target=".sticky" data-bs-offset="70">
    ...
    <header class="sticky" id="navbar-sticky">
        <div class="tagline d-none d-lg-block bg-dark">
            <div class="container">
                <div class="float-start info-link">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                            <i class="mdi mdi-phone-classic me-1"></i> <span class="font-size-13">+1 234 567 89 01</span>
                        </li>
                        <li class="list-inline-item">
                            <a href="#">
                                <i class="mdi mdi-email me-1"></i> <span class="font-size-13">info@mymail.com</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <!--Navbar Start-->
        <nav class="navbar navbar-expand-lg fixed-top navbar-custom navbar-light" id="navbar">
            <div class="container">
                <!-- LOGO -->
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ms-auto navbar-center" id="mySidenav">
                        ...
                        <li class="nav-item">
                            <div class="dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <section class="bg-home bg-primary" id="home">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="home-content text-center">
                        <h1 class="home-title mb-4 text-white">Here is the best way to present your apps</h1>
                        <p class="home-desc mb-4">Minton is a fully featured premium admin template built on top of awesome Bootstrap 5, modern web technology HTML5, CSS3 and jQuery.</p>
                        <div>
                            <a href="#" class="btn btn-light me-1">Contact us</a>
            ...
            <div class="home-img text-center">
                <img src="images/hero-1.png" alt="" class="img-fluid" style="max-width: 750px;">
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="services-box text-center mt-3 p-3">
                        ...
                        <p class="text-muted">Sed ut perspiciatis unde omnis iste natus error sit voluptatem doloremque.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="services-box text-center mt-3 p-3">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="services-box text-center mt-3 p-3">
                        ...
                        <p class="text-muted">Itaque earum rerum hic tenetur a sapiente delectus ut aut reiciendis maiores alias.</p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="mb-4">
                        <div class="feature-icon float-start">
                            <i class="pe-7s-notebook text-primary font-24 me-3"></i>
                        </div>
                    ...
                    <div class="mb-4">
                        <div class="feature-icon float-start">
                            <i class="pe-7s-edit text-primary font-24 me-3"></i>
                        </div>
                    ...
                    <div>
                        <div class="feature-icon float-start">
                            <i class="pe-7s-headphones text-primary font-24 me-3"></i>
                        </div>
            ...
            <div class="row align-items-center justify-content-center mt-5 pt-4">
                ...
                <div class="col-lg-5 ">
                    <div class="mb-4">
                        <div class="feature-icon float-start">
                            <i class="pe-7s-exapnd2 text-primary  font-24 me-3"></i>
                        </div>
            ...
            <div class="row" id="counter">
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center my-2 p-3">
                        ...
                        <div class="counter-content">
                            <h2 class="counter_value text-white mt-0 mb-3" data-target="1200">0</h2>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center my-2 p-3">
                        ...
                        <div class="counter-content">
                            <h2 class="counter_value text-white mt-0 mb-3" data-target="4900">10</h2>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center my-2 p-3">
                        ...
                        <div class="counter-content">
                            <h2 class="counter_value text-white mt-0 mb-3" data-target="5645">608</h2>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box text-center my-2 p-3">
                        ...
                        <div class="counter-content">
                            <h2 class="counter_value text-white mt-0 mb-3" data-target="800">2</h2>
                ...
                <div class="col-lg-4">
                    <div class="pricing-plan mt-3 p-3">
                        <div class="plan-header px-3 mt-3">
                            <div class="pricing-icon float-end">
                        ...
                        <div class="plan-content text-muted mb-4 px-3">
                            <p><i class="mdi mdi-check text-primary me-2"></i> 5 Projects</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> 1 GB Storage</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> No Domain</p>
                            <p><i class="mdi mdi-close text-danger me-2"></i> 1 User</p>
                            <p><i class="mdi mdi-close text-danger me-2"></i> Free Support</p>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="pricing-plan mt-3 p-3 active">
                        ...
                        <div class="plan-content text-muted mb-4 px-3">
                            ...
                            <p><i class="mdi mdi-check text-primary me-2"></i> 1 GB Storage</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> No Domain</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> 1 User</p>
                            <p><i class="mdi mdi-close text-danger me-2"></i> Free Support</p>
                        </div>
                        <div class="text-center py-3">
                            <a href="#" class="btn btn-purple">Purchase now</a>
                ...
                <div class="col-lg-4">
                    <div class="pricing-plan mt-3 p-3">
                        ...
                        <div class="plan-content text-muted mb-4 px-3">
                            ...
                            <p><i class="mdi mdi-check text-primary me-2"></i> No Domain</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> 1 User</p>
                            <p><i class="mdi mdi-check text-primary me-2"></i> Free Support</p>
                        </div>
                        <div class="text-center py-3">
                            <a href="#" class="btn btn-purple">Purchase now</a>
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <ul class="nav nav-pills faq-nav-tabs nav-justified mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item text-sm-start">
                            <a class="nav-link active" id="pills-general-tab" data-bs-toggle="pill" href="#pills-general" role="tab" aria-controls="pills-general" aria-selected="true">
                                <div class="clearfix">
                                    <i class="pe-7s-wallet text-purple float-md-end text-md-center h2 m-0"></i>
                                    <h4 class="me-2 d-none d-sm-inline-block">General Questions</h4>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item text-sm-start">
                            <a class="nav-link" id="pills-pricing-tab" data-bs-toggle="pill" href="#pills-pricing" role="tab" aria-controls="pills-pricing" aria-selected="false">
                                <div class="clearfix">
                                    <i class="pe-7s-notebook text-purple float-md-end h2 m-0"></i>
                                    <h4 class="me-2 d-none d-sm-inline-block">Pricing & Plans</h4>
                                </div>
                            </a>
                        </li>
                    </ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-4">
                                        <div class="faq-box mb-4">
                                            <div class="faq-question-q-box float-start me-4">Q.</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <p class="pt-1 text-white-50">Bootstrap 5 Admin Dashboard & Landing Page Template</p>
                    ...
                    <div class="pt-4">
                        <div class="text-center">
                            <p class="text-white-50 mb-0">
                                <script>document.write(new Date().getFullYear())</script> &copy; Minton. Design by <a href="https://coderthemes.com/" target="_blank" class="text-white-50">Coderthemes</a>
                            </p>
                        </div>
                    </div>
                </div>
