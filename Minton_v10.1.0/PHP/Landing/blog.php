            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ms-auto navbar-center" id="mySidenav">
                        ...
                        <li class="nav-item">
                            <a href="index.php#testimonial" class="nav-link">Testimonial</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <h3 class="page-header-title text-white mb-0">BLOG</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card overflow-hidden mb-4">
                                ...
                                <div class="blog-content p-3 mx-3">
                                    <h4 class="mt-0"><a href="blog-details.php" class="text-dark">Orange plant on a table</a></h4>
                        ...
                        <div class="col-lg-6">
                            <div class="card overflow-hidden mb-4">
                                ...
                                <div class="blog-content p-3 mx-3">
                                    <h4 class="mt-0"><a href="blog-details.php" class="text-dark">Beautiful Day In Paris</a></h4>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card overflow-hidden mb-4">
                                ...
                                <div class="blog-content p-3 mx-3">
                                    <h4 class="mt-0"><a href="blog-details.php" class="text-dark">A person riding a bicycle</a></h4>
                        ...
                        <div class="col-lg-6">
                            <div class="card overflow-hidden mb-4">
                                ...
                                <div class="blog-content p-3 mx-3">
                                    <h4 class="mt-0"><a href="blog-details.php" class="text-dark">Nature valley with cooling</a></h5>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card overflow-hidden mb-4">
                                ...
                                <div class="blog-content p-3 mx-3">
                                    <h4 class="mt-0"><a href="blog-details.php" class="text-dark">A person discuss for project </a></h4>
                                    <p class="text-muted mb-0">If several languages coalesce, the grammar of the resulting language</p>
                                </div>
                                <div class="blog-meta px-4 pb-3">
