<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Order Detail")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "eCommerce","title" =>"Order Detail")) ?>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="me-3">
                                                                                    <img src="/images/products/product-1.png" alt="product-img" height="40">
                                                                                </div>
                                                                                <div class="flex-1">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="me-3">
                                                                                    <img src="/images/products/product-6.png" alt="product-img" height="40">
                                                                                </div>
                                                                                <div class="flex-1">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="me-3">
                                                                                    <img src="/images/products/product-8.png" alt="product-img" height="40">
                                                                                </div>
                                                                                <div class="flex-1">
