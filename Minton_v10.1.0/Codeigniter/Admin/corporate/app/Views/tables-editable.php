<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Table Editable")) ?>
    ...
    <body>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Tables","title" => "Table Editable")) ?>
        ...
        <!-- Table editable init-->
        <script src="/js/pages/tabledit.init.js"></script>
