            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "General UI")) ?>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3>h3.Example heading <span class="badge bg-primary">New</span></h3>
                                        <h4>h4.Example heading <span class="badge badge-soft-info">Info Soft</span></h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <span class="badge bg-purple rounded-pill">Purple</span>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">
                                            ...
                                            Badge can be more contextual as well. Just use regular convention e.g. <code>bg-*color</code>, <code>bg-primary</code>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-1 fw-semibold">Default Pagination</p>
                                                ...
                                                <p class="mb-1 fw-semibold mt-4">Rounded Pagination</p>
                                                <p class="text-muted font-14">
                                                ...
                                                <p class="mb-1 fw-semibold mt-4">Sizing</p>
                                                <p class="text-muted font-14">
                                                    Add <code>
                                                    .pagination-lg</code>
                                                    or <code>
                                                ...
                                                <p class="mb-1 fw-semibold mt-4">Alignment</p>
                                                <p class="text-muted font-14">
