            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "Buttons")) ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="button-list">
                                            ...
                                            <button type="button" class="btn btn-purple rounded-pill waves-effect waves-light">Purple</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Outline Rounded Buttons</h4>
                                        <p class="sub-header">
                                            Add <code>.rounded-pill</code> to default button to get rounded corners.
                                        </p>
                                        ...
                                        <div class="button-list">
                                            ...
                                            <button type="button" class="btn btn-outline-purple rounded-pill waves-effect waves-light">Purple</button>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="button-list">
                                            ...
                                            <button type="button" class="btn btn-soft-purple waves-effect waves-light">Purple</button>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="button-list">
                                            ...
                                            <button type="button" class="btn btn-soft-purple rounded-pill waves-effect waves-light">Purple</button>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header">Use a classes <code>.btn-bordered</code> with <code>.btn-*</code> to quickly create a bordered buttons.</p>

                                        <div class="button-list">
                                            <button type="button" class="btn btn-primary btn-bordered waves-effect waves-light">Primary</button>
                                            <button type="button" class="btn btn-success btn-bordered waves-effect waves-light">Success</button>
                                            <button type="button" class="btn btn-info btn-bordered waves-effect waves-light">Info</button>
                                            <button type="button" class="btn btn-warning btn-bordered waves-effect waves-light">Warning</button>
                                            <button type="button" class="btn btn-danger btn-bordered waves-effect waves-light">Danger</button>
                                            <button type="button" class="btn btn-dark btn-bordered waves-effect waves-light">Dark</button>
                                            <button type="button" class="btn btn-purple btn-bordered waves-effect waves-light">Purple</button>
                                            <button type="button" class="btn btn-pink btn-bordered waves-effect waves-light">Pink</button>
                                            <button type="button" class="btn btn-secondary btn-bordered waves-effect">Secondary</button>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="button-list">
                                            <button type="button" class="btn btn-primary btn-bordered rounded-pill waves-effect waves-light">Primary</button>
                                            <button type="button" class="btn btn-success btn-bordered rounded-pill waves-effect waves-light">Success</button>
                                            <button type="button" class="btn btn-info btn-bordered rounded-pill waves-effect waves-light">Info</button>
                                            <button type="button" class="btn btn-warning btn-bordered rounded-pill waves-effect waves-light">Warning</button>
                                            <button type="button" class="btn btn-danger btn-bordered rounded-pill waves-effect waves-light">Danger</button>
                                            <button type="button" class="btn btn-dark btn-bordered rounded-pill waves-effect waves-light">Dark</button>
                                            <button type="button" class="btn btn-purple btn-bordered rounded-pill waves-effect waves-light">Purple</button>
                                            <button type="button" class="btn btn-pink btn-bordered rounded-pill waves-effect waves-light">Pink</button>
                                            <button type="button" class="btn btn-secondary btn-bordered rounded-pill waves-effect">Secondary</button>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="button-list">
                                            ...
                                            <button type="button" class="btn btn-purple waves-effect waves-light"><i class="mdi mdi-cog"></i></button>
                                        </div>
                                        <br/>
                                        <div class="button-list">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            ...
                                            <button type="button" class="btn btn-pink waves-effect waves-light">Block Button</button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            ...
                                            <div class="fileupload btn btn-secondary waves-effect">
                                                <span><i class="mdi mdi-cloud-upload me-1"></i>Upload</span>
                                                <input type="file" class="upload">
                                            </div>
                                        </div>
                                    </div><!-- end card-body -->
