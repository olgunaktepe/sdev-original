            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Extras","title" =>"Timeline")) ?>
                                            ...
                                            <div class="timeline-box">
                                                ...
                                                <div class="timeline-album">
                                                    <a href="javascript: void(0);">
                                                        <img alt="" src="/images/small/img-1.jpg">
                                                    </a>
                                                    <a href="javascript: void(0);">
                                                        <img alt="" src="/images/small/img-2.jpg">
                                                    </a>
                                                    <a href="javascript: void(0);">
                                                        <img alt="" src="/images/small/img-3.jpg">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                    <h4 class="mt-0 font-16">07 January 2020</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="mt-0 font-16">07 January 2020</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
                                                    <p class="mb-0">Download the new updates of Minton admin dashboard</p>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                    <h4 class="mt-0 font-16">07 January 2019</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow-alt"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                    <h4 class="mt-0 font-16">31 December 2019</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
                                                    <p class="mb-0">Download the new updates of Minton admin dashboard</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    <span class="arrow"></span>
                                                    <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                                    <h4 class="mt-0 font-16">16 Decembar 2019</h4>
                                                    <p class="text-muted"><small>08:25 am</small></p>
