<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Register & Signup 2")) ?>
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Already have account? <a href="auth-login-2" class="text-primary fw-medium ms-1">Sign In</a></p>
                        </footer>
