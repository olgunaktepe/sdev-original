            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "Notifications")) ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h5 class="font-14 mb-1">Basic</h5>
                                                ...
                                                <div class="p-3">
                                                    <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                                        <div class="toast-header">
                                                            <img src="/images/users/avatar-2.jpg" alt="user-image" height="28" class="me-1 rounded" />
                                                            <strong class="me-auto">Alfredo</strong>
                                            ...
                                            <div class="col-md-6">
                                                <h5 class="font-14 mb-1">Translucent</h5>
                                                ...
                                                <div class="p-3 bg-light">
                                                    <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                                        <div class="toast-header">
                                                            <img src="/images/users/avatar-2.jpg" alt="user-image" height="28" class="me-1 rounded" />
                                                            <strong class="me-auto">Andrew</strong>
                                                            <small>11 mins ago</small>
                                                            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                                                        </div>
                                                        <div class="toast-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mt-4">
                                                <h5 class="font-14 mb-1">Stacking</h5>
                                                    ...
                                                    <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
                                                        ...
                                                        <div class="toast-container" style="position: absolute; top: 0; right: 0;">
                                                            ...
                                                            <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-toggle="toast">
                                                                <div class="toast-header">
                                                                    <img src="/images/users/avatar-4.jpg" alt="user-image" height="28" class="me-1 rounded" />
                                                                    <strong class="me-auto">Richard</strong>
                                                            ...
                                                            <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-toggle="toast">
                                                                <div class="toast-header">
                                                                    <img src="/images/users/avatar-5.jpg" alt="user-image" height="28" class="me-1 rounded" />
                                                                    <strong class="me-auto">Edward</strong>
                                            ...
                                            <div class="col-md-6 mt-4">
                                                <h5 class="font-14 mb-1">Placement</h5>
                                                ...
                                                <div class="p-3">
                                                    <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center" style="min-height: 200px;">
                                                        ...
                                                        <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-toggle="toast">
                                                            <div class="toast-header">
                                                                <img src="/images/users/avatar-6.jpg" alt="user-image" height="28" class="me-1 rounded" />
                                                                <strong class="me-auto">Ronnie</strong>
                                                                <small>11 mins ago</small>
                                                                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                                                            </div>
                                                            <div class="toast-body">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="toast fade show d-flex align-items-center mt-4" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-body">
                                                Hello, world! This is a toast message.
                                            </div>
                                        ...
                                        <div class="toast fade show d-flex align-items-center text-white bg-primary border-0 mt-4" role="alert"
                                        ...
                                        <div class="toast fade show text-white bg-primary mt-4" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                            <div class="toast-body">
                                                Hello, world! This is a toast message.
                                                <div class="mt-2 pt-2 border-top">
                                        ...
                                        <div aria-live="polite" aria-atomic="true" class="bg-light position-relative bd-example-toasts"
                                            ...
                                            <div class="toast-container position-absolute p-3" id="toastPlacement">
                                                <div class="toast fade show">
                                                    <div class="toast-header">
                                                        <img src="/images/users/avatar-6.jpg" alt="user-image" height="28"
                                                            class="me-1 rounded" />
                                                        <strong class="me-auto">Ronnie</strong>
                                                        <small>11 mins ago</small>
                                                    </div>
