...
function styles() {
    ...
    src([`${paths.scss}/config/corporate/app.scss`, `${paths.scss}/config/corporate/bootstrap.scss`, `${paths.scss}/icons.scss`])
        .pipe(
            sass({
    ...
    // rtl css
    return src([`${paths.scss}/config/corporate/app.scss`, `${paths.scss}/config/corporate/bootstrap.scss`])
        .pipe(
            sass({
                importer: tildeImporter,
                includePaths: [paths.scss],
