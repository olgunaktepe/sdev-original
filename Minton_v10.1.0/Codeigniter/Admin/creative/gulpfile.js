...
function styles() {
    ...
    src([`${paths.scss}/config/creative/app.scss`, `${paths.scss}/config/creative/bootstrap.scss`, `${paths.scss}/icons.scss`])
        .pipe(
            sass({
    ...
    // rtl css
    return src([`${paths.scss}/config/creative/app.scss`, `${paths.scss}/config/creative/bootstrap.scss`])
        .pipe(
            sass({
                importer: tildeImporter,
                includePaths: [paths.scss],
