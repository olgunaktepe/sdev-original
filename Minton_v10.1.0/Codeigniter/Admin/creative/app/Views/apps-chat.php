            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Apps","title" => "Chat")) ?>
                                        ...
                                        <div class="d-flex align-items-start align-items-start mb-3">
                                            ...
                                            <div class="flex-1">
                                                <h5 class="mt-0 mb-0 font-15">
                                                    <a href="contacts-profile" class="text-reset">Nik Patel</a>
                                                </h5>
                                ...
                                <div class="card">
                                    <div class="card-body py-2 px-3 border-bottom border-light">
                                        <div class="d-flex py-1">
                                            ...
                                            <div class="flex-1">
                                                <h5 class="mt-0 mb-0 font-15">
                                                    <a href="contacts-profile" class="text-reset">James Zavel</a>
                                                </h5>
