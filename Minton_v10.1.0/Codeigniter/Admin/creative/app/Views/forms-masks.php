<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Form Masks")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Forms","title" => "Form Masks")) ?>
                                            ...
                                            <div class="col-md-6">
                                                <form action="#">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <span class="form-text">e.g "x-xx-xx-xx"</span>
                                                    </div>
                                                    <div class="mb-2">
                                                        ...
                                                        <span class="form-text">e.g "Your money"</span>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <span class="form-text">e.g "#.##0,00"</span>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <form action="#" class="mt-2 mt-md-0">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <span class="form-text">e.g "(xx) xxxx-xxxx"</span>
                                                    </div>
                                                    <div class="mb-2">
                                            ...
                                            <div class="col-md-6">
                                                <form action="#">
                                                    <div class="mb-2">
                                                        ...
                                                        <span class="form-text">e.g. "1.234.567.890.123"</span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Auto Numeric ($)</label>
                                                    ...
                                                    <div class="mb-2">
                                                        <label class="form-label">Auto Numeric (Rs.)</label>
                                                        <input type="text" placeholder="" data-a-sign="Rs. " class="form-control autonumber">
                                                        <span class="form-text">e.g. "Rs. 1,234,567,890,123"</span>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <span class="form-text">e.g. "¥ 1,2345,6789,0123"</span>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <form action="#" class="mt-2 mt-md-0">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <span class="form-text">e.g. "11%"</span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label class="form-label">Maximum Value (0 - 9999)</label>
                                                        <input type="text" placeholder="" data-v-max="9999" data-v-min="0" class="form-control autonumber">
                                                        <span class="form-text">e.g. "9,999"</span>
                                                    </div>

                                                    <div class="mb-2">
                                                        <label class="form-label">Range Value (-99.99 - 1000.00)</label>
                                                        <input type="text" placeholder="" data-v-min="-99.99" data-v-max="1000.00" class="form-control autonumber">
                                                        <span class="form-text">e.g. "1000 Or -99.99"</span>
                                                    </div>

                                                    <div>
                                                        <label class="form-label">Bracket Value</label>
                                                        ...
                                                        <span class="form-text">e.g. "(9,999.00)"</span>
                                                    </div>
