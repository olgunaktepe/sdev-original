            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "Cards")) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">With supporting text below as a natural lead-in to additional content. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <img class="card-img-bottom img-fluid" src="/images/small/img-6.jpg" alt="Card image cap" />
                                </div>
                                <!-- end card-box-->
                            </div>
                            <!-- end col -->
                            <div class="col-md-4">
                                <div class="card card-inverse text-white">
                                    <img class="card-img img-fluid" src="/images/small/img-7.jpg" alt="Card image" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4 class="mb-3">Background and color</h4>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="card text-white bg-primary mb-4">
                                    <div class="card-header bg-transparent border-bottom">Header</div>
                                    <div class="card-body">
                                        <h5 class="card-title">Primary card title</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4 class="mb-3">Card Horizontal</h4>
                            </div>
                            <div class="col-lg-6">
                                <div class="card mb-3">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="/images/small/img-4.jpg" alt="Card image" class="img-fluid" />
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-3">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-4">
                                            <img src="/images/small/img-5.jpg" alt="Card image" class="img-fluid" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h4 class="mb-3">Grid cards</h4>
                                <div class="row row-cols-1 row-cols-md-3 g-3">
                                    <div class="col">
                                        <div class="card">
                                            <img src="/images/small/img-4.jpg" class="card-img-top" alt="Card image" />
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="/images/small/img-6.jpg" class="card-img-top" alt="Card image" />
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <img src="/images/small/img-5.jpg" class="card-img-top" alt="Card image" />
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
