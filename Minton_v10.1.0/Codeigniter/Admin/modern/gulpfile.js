...
function styles() {
    ...
    src([`${paths.scss}/config/modern/app.scss`, `${paths.scss}/config/modern/bootstrap.scss`, `${paths.scss}/icons.scss`])
        .pipe(
            sass({
    ...
    // rtl css
    return src([`${paths.scss}/config/modern/app.scss`, `${paths.scss}/config/modern/bootstrap.scss`])
        .pipe(
            sass({
                importer: tildeImporter,
                includePaths: [paths.scss],
