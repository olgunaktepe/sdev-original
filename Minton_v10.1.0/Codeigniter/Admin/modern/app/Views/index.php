...
<head>
    ...
    <?php echo view("partials/title-meta", array("title" => "Sales Dashboard")) ?>
...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 text-center">
                                        ...
                                        <div dir="ltr">
                                            <div id="revenue-report" class="apex-charts" data-colors="#3bafda,#e3eaef">
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3 text-center">
                                        ...
                                        <div dir="ltr">
                                            <div id="products-sales" class="apex-charts" data-colors="#3bafda,#1abc9c">
                                            </div>
                                        </div>
    ...
    <!-- Dashboard init-->
    <script src="/js/pages/dashboard-sales.init.js"></script>
