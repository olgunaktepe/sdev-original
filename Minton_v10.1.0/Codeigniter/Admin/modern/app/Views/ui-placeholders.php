            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "Placeholders")) ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="card border shadow-none mb-md-0">
                                                    <img src="/images/small/img-2.jpg" class="card-img-top" alt="...">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border shadow-none mb-0" aria-hidden="true">
                                                    <img src="/images/small/img-4.jpg" class="card-img-top" alt="...">
                                                    <div class="card-body">
