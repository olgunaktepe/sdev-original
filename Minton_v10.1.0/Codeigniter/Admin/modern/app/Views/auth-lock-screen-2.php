<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Lock Screen 2")) ?>
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Not you? return <a href="auth-login-2" class="text-primary fw-medium ms-1">Sign In</a></p>
                        </footer>
