<?= $this->include("partials/html") ?>
    ...
    <body>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "eCommerce","title" => "Customers")) ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                                                <a href="javascript:void(0);" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-1"></i> Add Customers</a>
                                            </div>
                                            <div class="col-sm-8">
                                            ...
                                            <table class="table table-centered dt-responsive nowrap w-100" id="products-datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-4.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">John Delaney</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-5.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">George Beasley</a></h5>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="avatar-sm me-3">
                                                                    <div class="avatar-title rounded-circle bg-soft-primary fw-medium text-primary">
                                                                        M
                                                                    </div>
                                                                </div>
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Mary Gonzalez</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-6.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Roberto Norton</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-7.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Jose Payson</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-8.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Frank King</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Anne Martinez</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-9.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Olive Hedin</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Clara Ramsey</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-10.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Jeff Luck</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-4.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Bruce Williams</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <img src="/images/users/avatar-5.jpg" alt="table-user" class="me-3 rounded-circle avatar-sm">
                                                                <div class="flex-1">
                                                                    <h5 class="mt-0 mb-1"><a href="javascript:void(0);" class="text-dark">Tyler Davis</a></h5>
        ...
        <script src="/libs/jquery-datatables-checkboxes/js/dataTables.checkboxes.min.js"></script>
        <!-- third party js ends -->

        <!-- Datatables init -->
        <script src="/js/pages/customers.init.js"></script>
