            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "Dropdowns")) ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mt-5">
                                                    <h5 class="mb-1">Dropend variation</h5>
                                                    <p class="text-muted font-13 mb-2">
                                                    ...
                                                    <!-- Split droprdropendight button -->
                                                    <div class="btn-group mt-2 me-1 dropend">
                                                        <button type="button" class="btn btn-light waves-effect">
                                                            Split Dropend
                                                        </button>
                                                        <button type="button" class="btn btn-light waves-effect dropdown-toggle-split dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <div class="btn-group dropup mt-2 me-1">
                                                        <button type="button" class="btn btn-purple waves-effect waves-light dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropup <i class="mdi mdi-chevron-up"></i></button>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#">Action</a>
                                                            <a class="dropdown-item" href="#">Another action</a>
                                                            <a class="dropdown-item" href="#">Something else here</a>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mt-5 mt-xl-0">
                                                    ...
                                                    <div class="btn-group dropdown mt-2 me-1">
                                                ...
                                                <div class="mt-5">
                                                    <h5 class="mb-1">Dropstart variation</h5>
                                                    <p class="text-muted font-13 mb-2">
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <div class="btn-group mt-2">
                                                        <button type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false">
