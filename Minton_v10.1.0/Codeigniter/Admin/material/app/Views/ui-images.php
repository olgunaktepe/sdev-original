            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Base UI","title" => "Images")) ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="mt-3">
                                                            <img src="/images/small/img-3.jpg" alt="image"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md col-sm-6">
                                                <div class="mt-3">
                                                    <img src="/images/users/avatar-3.jpg" alt="image"
                                                        class="img-fluid avatar-md rounded-end"/>
                                                    <p class="mb-0">
                                            ...
                                            <div class="col-md col-sm-6">
                                                <div class="mt-3">
                                                    <img src="/images/users/avatar-3.jpg" alt="image"
                                                    class="img-fluid avatar-md rounded-bottom"/>
                                                    <p class="mb-0">
                                            ...
                                            <div class="col-md col-sm-6">
                                                <div class="mt-3">
                                                    <img src="/images/users/avatar-3.jpg" alt="image"
                                                        class="img-fluid avatar-md rounded-start"/>
                                                    <p class="mb-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md col-sm-6">
                                                <div class="mt-3">
                                                    <img src="/images/users/avatar-2.jpg" alt="image"
                                                        class="img-fluid avatar-md rounded-2"/>
                                                    <p class="mb-0">
                                                        <code>.rounded-2</code>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-md col-sm-6">
                                                <div class="mt-3">
                                                    <img src="/images/users/avatar-2.jpg" alt="image"
                                                    class="img-fluid avatar-md rounded-3"/>
                                                    <p class="mb-0">
                                                        <code>.rounded-3</code>
                                                    </p>
                                                </div>
