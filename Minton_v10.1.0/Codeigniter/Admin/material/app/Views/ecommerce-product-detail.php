<?= $this->include("partials/html") ?>
    ...
    <head>
        <?php echo view("partials/title-meta", array("title" => "Product Detail")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "eCommerce","title" => "Product Detail")) ?>
                                                            ...
                                                            <div>
                                                                <button type="button"
                                                                    ...
                                                                    <span class="btn-label"><i
                                                                            class="mdi mdi-cart"></i></span>Add to cart
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
