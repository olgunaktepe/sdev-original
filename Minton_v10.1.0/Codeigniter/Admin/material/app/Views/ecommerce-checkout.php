            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "eCommerce","title" => "Checkout")) ?>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-centered table-nowrap mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <img src="/images/products/product-6.png" alt="product-img"
                                                                                title="product-img" class="rounded" height="48" />
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <img src="/images/products/product-8.png" alt="product-img"
                                                                                title="product-img" class="rounded me-2" height="48" />
                                                                        </td>
                                                                        <td>
