<?= $this->include("partials/html") ?>
    ...
    <head>
        <?php echo view("partials/title-meta", array("title" => "Logout 2")) ?>
        ...
        <div class="auth-fluid">
            ...
            <div class="auth-fluid-right">
                <div class="auth-user-testimonial">
                    ...
                    <p class="lead fw-normal"><i class="mdi mdi-format-quote-open"></i> I've been using this theme for a
                        while and I must say that whenever I am looking for a design - I refer to this theme for specifics &
                        implementation. With wide arrays of components, designs, charts - I would highly recommend this
                        theme for anyone using it for dashboard or project management usage.. <i
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                            ...
                            <div class="mt-4">
                                <div class="logout-checkmark">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <circle class="logout-path" fill="none" stroke="#1abc9c" stroke-width="4"
                                            stroke-miterlimit="10" cx="80.6" cy="80.6" r="62.1"></circle>
                                        <polyline class="logout-path" fill="none" stroke="#1abc9c" stroke-width="6"
                                            stroke-linecap="round" stroke-miterlimit="10" points="113,52.8
                                            74.1,108.4 48.2,86.4 "></polyline>

                                        <circle class="logout-spin" fill="none" stroke="#d1dee4" stroke-width="4"
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">Back to <a href="auth-login-2" class="text-primary fw-medium ms-1">Sign In</a>
                            </p>
                        </footer>
