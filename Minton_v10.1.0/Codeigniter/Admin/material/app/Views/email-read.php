<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Email Read")) ?>
    ...
    <body>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Email","title" => "Email Read")) ?>                        
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="inbox-leftbar">
                                            ...
                                            <div class="mail-list mt-4">
                                                ...
                                                <a href="javascript: void(0);"><i class="ri-send-plane-2-line align-bottom me-2"></i>Sent Mail</a>
        ...
        <script src="/js/pages/email.init.js"></script>
