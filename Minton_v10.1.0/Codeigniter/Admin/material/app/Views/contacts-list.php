<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Contacts & Members Listing")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Contacts","title" => "Members List")) ?>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Denver Barker</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Robert McBride</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Peter White</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Ronald Myrick</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Paul Halpern</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Ricky Atwell</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">James Richards</a></h4>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="text-center card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-3 mb-1"><a href="contacts-profile" class="text-dark">Charles Martinez</a></h4>
