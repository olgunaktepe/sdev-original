                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="<?= base_url('loginCheck') ?>">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control" type="email" id="emailaddress" placeholder="Enter your email" name="email" value="user@demo.com">
                                    </div>

                                    <div class="mb-2">
                                        <label for="password" class="form-label">Password</label>
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="password" class="form-control" placeholder="Enter your password" name="password" value="password">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="auth-recoverpw" class="text-muted ms-1">Forgot your password?</a></p>
                                <p class="text-muted">Don't have an account? <a href="auth-register" class="text-primary fw-medium ms-1">Sign Up</a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
