...
function styles() {
    ...
    src([`${paths.scss}/config/default/app.scss`, `${paths.scss}/config/default/bootstrap.scss`, `${paths.scss}/icons.scss`])
        .pipe(
            sass({
    ...
    // rtl css
    return src([`${paths.scss}/config/default/app.scss`, `${paths.scss}/config/default/bootstrap.scss`])
        .pipe(
            sass({
                importer: tildeImporter,
                includePaths: [paths.scss],
