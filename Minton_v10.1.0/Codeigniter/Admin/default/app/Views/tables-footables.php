<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "FooTable")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Tables","title" => "FooTable")) ?>
                                        ...
                                        <div class="table-responsive">
                                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>3 Oct 1981</td>
                                                    <td><span class="badge label-table bg-secondary text-light text-light">Disabled</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Granville</td>
                                                    <td>Leonardo</td>
