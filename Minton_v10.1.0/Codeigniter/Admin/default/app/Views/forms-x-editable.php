<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "X Editable")) ?>

        <!-- Plugins css -->
        <link href="/libs/x-editable/bootstrap-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" />
    ...
    <body>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Forms","title" => "X Editable")) ?>
        ...
        <script src="/libs/x-editable/bootstrap-editable/js/bootstrap-editable.min.js"></script>
