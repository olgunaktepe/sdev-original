...
<head>
    ...
    <?php echo view("partials/title-meta", array("title" => "CRM Dashboard")) ?>
...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            ...
            <?php echo view("partials/page-title", array("title" => "CRM", "subTitle" => "Dashboard")) ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-3" dir="ltr">
                                    <div id="campaigns-chart" class="apex-charts"
                                         data-colors="#f7b84b,#1abc9c,#3bafda"></div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mt-3">
                                            <img class="avatar-sm align-self-center me-3 rounded-circle"
                                                 src="/images/users/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="flex-1">
                                        ...
                                        <div class="d-flex mt-3">
                                            <img class="avatar-sm align-self-center me-3 rounded-circle"
                                                 src="/images/users/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="flex-1">
                                        ...
                                        <div class="d-flex mt-3">
                                            <img class="avatar-sm align-self-center me-3 rounded-circle"
                                                 src="/images/users/avatar-5.jpg" alt="Generic placeholder image">
                                            <div class="flex-1">
                                                <span class="badge badge-soft-warning float-end">Cold lead</span>
                                        ...
                                        <div class="d-flex mt-3">
                                            <img class="avatar-sm align-self-center me-3 rounded-circle"
                                                 src="/images/users/avatar-1.jpg" alt="Generic placeholder image">
                                            <div class="flex-1">
                                                <span class="badge badge-soft-warning float-end">Cold lead</span>
                                        ...
                                        <div class="d-flex mt-3">
                                            <img class="avatar-sm align-self-center me-3 rounded-circle"
                                                 src="/images/users/avatar-6.jpg" alt="Generic placeholder image">
                                            <div class="flex-1">
                                                <span class="badge badge-soft-success float-end">Won lead</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-auto d-grid">
                                                        <button class="btn btn-primary btn-md width-sm waves-effect waves-light"
                                                                type="submit" id="todo-btn-submit">Add
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
