            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "eCommerce","title" => "Shopping Cart")) ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div>
                                                        ...
                                                        <table class="table table-centered mb-0 table-nowrap">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail" class="text-body">Blue color T-shirt</a></h5>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail" class="text-body">Half sleeve maroon T-shirt</a></h5>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail" class="text-body">Blue Hoodie for men</a></h5>
                                                                        <p class="mb-0">Size : <span class="fw-medium">Large</span></p>
                                                                    </td>
                                                                    <td>
                                                                        $ 45
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="mt-0 mb-1 text-truncate"><a href="ecommerce-product-detail" class="text-body">Full sleeve Pink T-shirt</a></h5>
                                                                        <p class="mb-0">Size : <span class="fw-medium">medium</span></p>
                                                                    </td>
                                                                    <td>
                                                                        $ 45
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-sm-6">
                                                            <a href="ecommerce-products" class="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">
                                                                <i class="mdi mdi-arrow-left"></i> Continue Shopping </a>
                                                        </div> <!-- end col -->
                                                        <div class="col-sm-6">
                                                            <div class="text-sm-end">
                                                                <a href="ecommerce-checkout" class="btn btn-danger"><i class="mdi mdi-cart-plus me-1"></i> Checkout </a>
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row-->
                                                </div>
