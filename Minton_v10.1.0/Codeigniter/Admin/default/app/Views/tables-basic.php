        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php echo view("partials/page-title", array("subTitle" => "Tables","title" => "Basic Tables")) ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-dark text-white mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th class="bg-success" scope="row">2</th>
                                                    <td class="bg-success">Jacob</td>
                                                    <td class="bg-success">Thornton</td>
                                                    <td class="bg-success">@fat</td>
                                                </tr>
                                                <tr>
                                                    <th class="bg-pink" scope="row">3</th>
                                                    <td class="bg-pink">Larry</td>
                                                    <td class="bg-pink">the Bird</td>
                                                    <td class="bg-pink">@twitter</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div> <!-- end table-responsive-->
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="sub-header"> Border styles, active styles, and table variants are not
