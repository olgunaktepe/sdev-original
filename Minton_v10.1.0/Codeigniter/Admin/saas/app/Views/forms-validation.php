            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Forms","title" => "Form Validation")) ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="#" class="parsley-examples">
                                            ...
                                            <div class="mb-2">
                                                <div class="form-check form-checkbox-purple">
                                                    <input id="checkbox6a" type="checkbox" class="form-check-input" checked>
