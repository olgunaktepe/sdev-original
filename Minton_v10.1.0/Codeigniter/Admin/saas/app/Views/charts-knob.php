<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Jquery knob Charts")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Charts","title" => "Jquery knob")) ?>
                                    ...
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input data-plugin="knob" data-width="150" data-height="150" data-bgColor="rgba(150, 150, 150, 0.1)"
                                               data-fgColor="#3bafda" data-displayInput=false value="35"/>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            data-fgColor="#1abc9c" value="29"  data-knob-icon="icon-dollar"/>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            data-fgColor="#37cde6" data-displayPrevious=true value="44"/>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input data-plugin="knob" data-width="150" data-height="150" data-min="-100" data-bgColor="rgba(150, 150, 150, 0.1)"
                                            data-fgColor="#f7b84b" data-displayPrevious=true data-angleOffset=-125
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input data-plugin="knob" data-width="150" data-height="150" data-bgColor="rgba(150, 150, 150, 0.1)"
                                            data-angleOffset="90" data-linecap="round" data-fgColor="#f1556c"
                                            value="35"/>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            data-fgColor="#6559cc" value="80" data-skin="tron" data-angleOffset="180" data-bgColor="rgba(150, 150, 150, 0.1)"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            data-displayPrevious=true data-fgColor="#f672a7" data-skin="tron"
