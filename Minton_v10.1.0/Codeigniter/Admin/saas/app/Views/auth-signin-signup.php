<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Auth Pages | Create Account | Sign In")) ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-sm-3">
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="mb-3">
                                                    <a href="auth-recoverpw" class="text-muted font-13 float-end">Forgot your password?</a>
                                                    <label for="password" class="form-label">Password</label>
                                                    <input class="form-control" type="password" required="" id="password" placeholder="Enter your password">
                                                </div>
            
                                                <div class="mb-3">
                                                    <button class="btn btn-primary float-sm-end" type="submit"> Log In </button>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-sm-3">
                                            ...
                                            <form action="#">
                                                ...
                                                <div>
                                                    <button class="btn btn-success float-sm-end" type="submit"> Sign Up </button>
                                                    <div class="form-check pt-1 overflow-hidden">
