<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Invoice")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "Extras","title" => "Invoice")) ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-end">
                                                    <p class="m-b-10"><strong>Order Date : </strong> <span class="float-end"> &nbsp;&nbsp;&nbsp;&nbsp; Jan 17, 2019</span></p>
                                                    <p class="m-b-10"><strong>Order Status : </strong> <span class="float-end"><span class="badge bg-danger">Unpaid</span></span></p>
                                        ...
                                        <div class="mt-4 mb-1">
                                            <div class="text-end d-print-none">
                                                <a href="javascript:window.print()" class="btn btn-primary waves-effect waves-light me-1"><i class="mdi mdi-printer me-1"></i> Print</a>
