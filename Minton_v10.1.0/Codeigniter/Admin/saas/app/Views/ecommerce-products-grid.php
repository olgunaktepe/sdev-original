<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Products Grid")) ?>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view("partials/page-title", array("subTitle" => "eCommerce","title" => "Products Grid")) ?>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Blue color T-shirt</a> </h5>
                                            <p class="text-muted">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Half sleeve maroon T-shirt</a> </h5>
                                            <p class="text-muted">
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Cream color T-shirt</a> </h5>
                                            <p class="text-muted">
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Half sleeve T-shirt</a> </h5>
                                            <p class="text-muted">
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Blue Hoodie for men</a> </h5>
                                            <p class="text-muted">
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Vneck green T-shirt</a> </h5>
                                            <p class="text-muted">
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card product-box">
                                    ...
                                    <div class="product-info border-top p-3">
                                        ...
                                        <div>
                                            <h5 class="font-16 mt-0 mb-1"><a href="ecommerce-product-detail" class="text-dark">Full sleeve Pink T-shirt</a> </h5>
                                            <p class="text-muted">
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
                                                <i class="mdi mdi-star text-warning"></i>
