<?= $this->include("partials/html") ?>
    <head>
        <?php echo view("partials/title-meta", array("title" => "Auth Pages | Create Account | Sign In 2")) ?>
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="tab-login">
                                ...
                                <form action="#">
                                    ...
                                    <div class="mb-2">
                                        <a href="auth-recoverpw-2" class="text-muted float-end"><small>Forgot your password?</small></a>
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted"><script>document.write(new Date().getFullYear())</script> &copy; Minton theme by <a href="javascript: void(0);" class="text-dark">Coderthemes</a> </p>
                        </footer>
