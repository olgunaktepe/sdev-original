@extends('layouts.vertical', ['page_title' => 'Tooltips & Popovers', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-list" id="tooltip-container">
                        ...
                        <button type="button" class="btn btn-light" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tooltip on bottom">Tooltip on
                            bottom</button>

                        <button type="button" class="btn btn-light" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="left" title="Tooltip on left">Tooltip on
                            left</button>

                        <button type="button" class="btn btn-light" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="right" title="Tooltip on right">Tooltip on
                            right</button>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="mt-4">
                                    <h5 class="mb-1">Interactivity</h5>
                                    <p class="sub-header font-13">
                                        Tooltips can be interactive, meaning they won't hide when you hover over or click on
                                        them.
                                    </p>
                                    <div class="button-list">
                                        ...
                                        <button class="btn btn-sm btn-primary waves-effect waves-light" title="I&#39;m a Tippy tooltip!" data-plugin="tippy" data-tippy-interactive="true" data-tippy-trigger="click">Interactive
                                            (click)</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 mt-4 mt-xl-0">
                                ...
                                <div class="button-list">
                                    ...
                                    <button class="btn btn-sm btn-primary waves-effect waves-light" title="I&#39;m a Tippy tooltip!" data-plugin="tippy" data-tippy-animation="shift-away" data-tippy-inertia="true" data-tippy-duration="[600, 300]" data-tippy-arrow="true">Inertia
                                        (shift-away)</button>
                                    <button class="btn btn-sm btn-primary waves-effect waves-light" title="I&#39;m a Tippy tooltip!" data-plugin="tippy" data-tippy-animation="shift-toward" data-tippy-inertia="true" data-tippy-duration="[600, 300]" data-tippy-arrow="true">Inertia
                                        (shift-toward)</button>
                                    ...
                                    <button class="btn btn-sm btn-primary waves-effect waves-light" title="I&#39;m a Tippy tooltip!" data-plugin="tippy" data-tippy-animation="perspective" data-tippy-inertia="true" data-tippy-duration="[600, 300]" data-tippy-arrow="true">Inertia
                                        (perspective)</button>
                                </div>
