        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
                        ...
                        <div class="offcanvas-body">
                            <ul>
                                ...
                                <li class="mt-1">Aenean vulputate eleifend tellus aenean leo ligula eleifend condimentum
                                    enim.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="button-list">
                        <!-- offcanvas Scrolling -->
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">Enable body
                            scrolling</button>
                        <!-- offcanvas Backdrop -->
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBackdrop" aria-controls="offcanvasWithBackdrop">Enable backdrop
                            (default)</button>
                        <!-- offcanvas Options -->
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">Enable
                ...
                <div class="card-body">
                    ...
                    <div class="button-list">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Toggle right
                            offcanvas</button>
                        <!-- offcanvas Bottom -->
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">Toggle bottom
                            offcanvas</button>
                        <!-- offcanvas Left -->
