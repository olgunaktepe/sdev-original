        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="full-screen-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fullScreenModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-fullscreen">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="fullScreenModalLabel">Modal Heading</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <h6>Text in a modal</h6>
                    ...
                    <div class="button-list">
                        ...
                        <!-- Full Screen modal -->
                        <button type="button" class="btn btn-purple" data-bs-toggle="modal" data-bs-target="#full-screen-modal">Full Screen Modal</button>
                        <!-- Full width modal -->
                        <button type="button" class="btn btn-pink" data-bs-toggle="modal" data-bs-target="#full-width-modal">Full width Modal</button>
                        <!-- Scrollable modal -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form action="#" class="px-3">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="login-rememberCheck">
                                                <label class="form-check-label" for="login-rememberCheck">Remember
                                                    me</label>
                                            </div>
                                        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">Specify the position for the modal. You can display modal at top, bottom, center
                        or right of page by specifying
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">Display a series of modals one by one to guide your users on multiple aspects or
