                    ...
                    <div class="inbox-rightbar">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex align-items-start mb-3 mt-1">
                                <img class="me-2 rounded-circle" src="/images/users/avatar-2.jpg" alt="placeholder image" height="32">
                                <div class="flex-1">
                            ...
                            <p>Hi Coderthemes!</p>
                            <p>Clicking ‘Order Service’ on the right-hand side of the above page will present you with an
                                order page. This service has the following Briefing Guidelines that will need to be filled
                            ...
                            <ol>
                                ...
                                <li>Do you have any preference or specific thing you would like to change or improve on your
                                    item page? </li>
                                <li>Do you want to include your item's or your provider's logo on the page? if yes, please
                                    send it to me in vector format (Ai or EPS) </li>
                                <li>Please provide me with the copy or text to display</li>
                            </ol>

                            <p>Filling in this form with the above information will ensure that they will be able to start
                                work quickly.</p>
                                    ...
                                    <div class="card mb-1 shadow-none border">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col ps-0">
                                                    <a href="javascript:void(0);" class="text-muted fw-semibold">Minton-admin-design.zip</a>
                                    ...
                                    <div class="card mb-1 shadow-none border">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col ps-0">
                                                    <a href="javascript:void(0);" class="text-muted fw-semibold">Dashboard-design.jpg</a>
