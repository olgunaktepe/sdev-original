                ...
                <div class="card-body">
                    ...
                    <div class="inbox-leftbar">
                        ...
                        <div class="mail-list mt-4">
                            <a href="javascript: void(0);" class="text-danger"><i class="ri-inbox-fill align-bottom me-2"></i>Inbox<span class="badge badge-soft-danger float-end ms-2">7</span></a>
                            <a href="javascript: void(0);"><i class="ri-star-line align-bottom me-2"></i>Starred</a>
                            <a href="javascript: void(0);"><i class="ri-time-line align-bottom me-2"></i>Snoozed</a>
                            <a href="javascript: void(0);"><i class="ri-file-list-2-line align-bottom me-2"></i>Draft<span class="badge badge-soft-info float-end ms-2">32</span></a>
                            <a href="javascript: void(0);"><i class="ri-send-plane-2-line align-bottom me-2"></i>Sent
                                Mail</a>
                            <a href="javascript: void(0);"><i class="ri-delete-bin-line align-bottom me-2"></i>Trash</a>
                            <a href="javascript: void(0);"><i class="ri-price-tag-3-line align-bottom me-2"></i>Important</a>
                            <a href="javascript: void(0);"><i class="ri-error-warning-line align-bottom me-2"></i>Spam</a>
                        </div>
                        ...
                        <div class="mt-3">
                            <ul class="message-list">
                                <li class="unread">
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Lucas Kriebel (@LucasKriebel) has sent
                                            ...
                                            <span class="teaser">@LucasKriebel - Very cool :) Nicklas, You have a new
                                                direct message.</span>
                                        </a>
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Last pic over my village &nbsp;&ndash;&nbsp;
                                            <span class="teaser">Yeah i'd like that! Do you remember the video you showed
                                                me of your train ride between Colombo and Kandy? The one with the mountain
                                                view? I would love to see that one again!</span>
                                        </a>
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Mochila Beta: Subscription Confirmed
                                            &nbsp;&ndash;&nbsp; <span class="teaser">You've been confirmed! Welcome to the
                                                ruling class of the inbox. For your records, here is a copy of the
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Off on Thursday &nbsp;&ndash;&nbsp;
                                            <span class="teaser">Eff that place, you might as well stay here with us
                                                instead! Sent from my iPhone 4 &gt; 4 mar 2014 at 5:55 pm</span>
                                        </a>
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">This Week's Top Stories &nbsp;&ndash;&nbsp;
                                            <span class="teaser">Our top pick for you on Medium this week The Man Who
                                                Destroyed America’s Ego</span>
                                        </a>
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Task assigned: Clone ARP's website
                                            &nbsp;&ndash;&nbsp; <span class="teaser">You have been assigned a task by
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Let's go fishing! &nbsp;&ndash;&nbsp;
                                            <span class="teaser">Hey, You wanna join me and Fred at the lake tomorrow?
                                                It'll be awesome.</span>
                                        </a>
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">1 new items in your Stackexchange inbox
                                            &nbsp;&ndash;&nbsp; <span class="teaser">The following items were added to your
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">You can now use your storage in Google
                                            Drive &nbsp;&ndash;&nbsp; <span class="teaser">Hey Nicklas Sandell! Thank you
                                ...
                                <li class="unread">
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Train/Bus &nbsp;&ndash;&nbsp; <span class="teaser">Yes ok, great! I'm not stuck in Stockholm anymore, we're
                                                making progress.</span>
                                        </a>
                                ...
                                <li>
                                    ...
                                    <div class="col-mail col-mail-2">
                                        <a href="" class="subject">Hello &nbsp;&ndash;&nbsp; <span class="teaser">Trip home from Colombo has been arranged, then Jenna will
                                                come get me from Stockholm. :)</span>
                                        </a>
...
@section('script')
    @vite(['resources/js/pages/email.init.js'])
