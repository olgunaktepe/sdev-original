@extends('layouts.vertical', ['page_title' => 'Product Details', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                                    ...
                                    <div id="product-carousel" class="carousel slide product-detail-carousel" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div>
                                                    <img src="/images/products/product-6.png" alt="product-img" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>
                                                    <img src="/images/products/product-8.png" alt="product-img" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div>
                                                    <img src="/images/products/product-1.png" alt="product-img" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                        <ol class="carousel-indicators product-carousel-indicators mt-2">
                                            <li data-bs-target="#product-carousel" data-bs-slide-to="0" class="active">
                                                <img src="/images/products/product-6.png" alt="product-img" class="img-fluid product-nav-img">
                                            </li>
                                            <li data-bs-target="#product-carousel" data-bs-slide-to="1">
                                                <img src="/images/products/product-8.png" alt="product-img" class="img-fluid product-nav-img">
                                            </li>
                                            <li data-bs-target="#product-carousel" data-bs-slide-to="2">
                                                <img src="/images/products/product-1.png" alt="product-img" class="img-fluid product-nav-img">
                                            </li>
                                        </ol>
                                    </div>
                                </div>
