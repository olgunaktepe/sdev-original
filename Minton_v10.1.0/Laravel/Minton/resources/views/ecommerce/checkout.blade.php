@extends('layouts.vertical', ['page_title' => 'Checkout', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                        ...
                        <div class="col-xl-8">
                            <div id="checkout-nav-pills-wizard" class="twitter-bs-wizard form-wizard-header">
                                <ul class="twitter-bs-wizard-nav mb-2">
                                    ...
                                    <li class="nav-item">
                                        <a href="#shipping-info" class="nav-link" data-bs-toggle="tab" data-toggle="tab">
                                    ...
                                    <div class="tab-pane" id="billing-info">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" id="shipdifferent-check">
                                                                <label class="form-check-label" for="shipdifferent-check">Ship to different address
                                                                    ?</label>
                                                            </div>
                                                        </div>
                                        ...
                                        <ul class="pager wizard list-inline mt-2">
                                            <li class="list-inline-item">
                                                <a href="{{ route('second', ['ecommerce', 'cart']) }}" class="btn btn-secondary"><i class="mdi mdi-arrow-left"></i> Back to Shopping Cart </a>
                                            </li>
                                            <li class="next list-inline-item float-end">
                                                <button type="button" class="btn btn-success"><i class="mdi mdi-truck-fast me-1"></i> Proceed to Shipping </button>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="shipping-info">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="border p-3 rounded mb-3 mb-md-0">
                                                        ...
                                                        <p class="mb-1"><span class="fw-semibold me-2">Address:</span>
                                                            3559 Roosevelt Wilson Lane San Bernardino, CA 92405</p>
                                                        <p class="mb-1"><span class="fw-semibold me-2">Phone:</span>
                                                            (123) 456-7890</p>
                                                        <p class="mb-0"><span class="fw-semibold me-2">Mobile:</span>
                                                            (+01) 12345 67890</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <ul class="pager wizard list-inline mt-3">
                                            <li class="previous list-inline-item">
                                                <button type="button" class="btn btn-secondary"><i class="mdi mdi-arrow-left me-1"></i> Back to Billing</button>
                                            </li>
                                            <li class="next list-inline-item float-end">
                                                <button type="button" class="btn btn-success"><i class="mdi mdi-cash-multiple me-1"></i> Continue to Payment
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="border p-3 mb-3 rounded">
                                                ...
                                                <div class="form-check form-check-inline font-16 mb-0">
                                                    ...
                                                    <label class="form-check-label" for="BillingOptRadio1">Pay with
                                                        Paypal</label>
                                                </div>
                                            ...
                                            <div class="border p-3 mb-3 rounded">
                                                ...
                                                <div class="form-check form-check-inline font-16 mb-0">
                                                    ...
                                                    <label class="form-check-label" for="BillingOptRadio2">Credit / Debit
                                                        Card</label>
                                                </div>
                                                <p class="mb-0 ps-3 pt-1">Safe money transfer using your bank account. We
                                            ...
                                            <div class="border p-3 mb-3 rounded">
                                                ...
                                                <div class="form-check form-check-inline font-16 mb-0">
                                                    ...
                                                    <label class="form-check-label" for="BillingOptRadio3">Cash on
                                                        Delivery</label>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 80px;">
                                                        <img src="/images/products/product-1.png" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('second', ['ecommerce', 'product-detail']) }}" class="text-body fw-semibold">Blue color T-shirt</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-6.png" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>

                                                    <td>
                                                        <a href="{{ route('second', ['ecommerce', 'product-detail']) }}" class="text-body fw-semibold">Blue Hoodie for men</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-8.png" alt="product-img" title="product-img" class="rounded me-2" height="48" />
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('second', ['ecommerce', 'product-detail']) }}" class="text-body fw-semibold">Full sleeve Pink T-shirt</a>
...
@section('script')
    @vite(['resources/js/pages/ecommerce-checkout.init.js'])
@endsection
