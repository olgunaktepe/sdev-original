@extends('layouts.vertical', ['page_title' => 'Ecommerce Orders', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2048</a> </td>
                                    <td>James Modlin</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2047</a> </td>
                                    <td>Lessie Craig</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2046</a> </td>
                                    <td>Tia McCord</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2045</a> </td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2044</a> </td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2043</a> </td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2042</a> </td>
                                    <td>Julius West</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2041</a> </td>
                                    <td>Janice Louie</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2040</a> </td>
                                    <td>Marie Harris</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce', 'orders-detail']) }}" class="text-body fw-medium">#MN2039</a> </td>
                                    <td>Robin Hill</td>
                                    <td>
