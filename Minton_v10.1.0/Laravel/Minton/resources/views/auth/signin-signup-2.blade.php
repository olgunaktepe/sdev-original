...
<head>
    @include('layouts.shared/title-meta', ['title' => 'Auth Pages | Create Account | Sign In 2'])
    ...
    <div class="auth-fluid">
        ...
        <div class="auth-fluid-right">
            <div class="auth-user-testimonial">
                ...
                <p class="lead fw-normal"><i class="mdi mdi-format-quote-open"></i> I've been using this theme for a while
                    and I must say that whenever I am looking for a design - I refer to this theme for specifics &
                    implementation. With wide arrays of components, designs, charts - I would highly recommend this
                    theme for anyone using it for dashboard or project management usage.. <i class="mdi mdi-format-quote-close"></i>
                </p>
                <h5 class="text-white">
                    - Admin User
                </h5>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab-login">
                            ...
                            <form action="#">
                                ...
                                <div class="mb-2">
                                    <a href="{{ route('second', ['auth', 'recoverpw-2']) }}" class="text-muted float-end"><small>Forgot your
                                            password?</small></a>
                        ...
                        <div class="tab-pane" id="tab-signup">
                            <p class="text-muted mb-3">Don't have an account? Create your own account, it takes less
                                than a minute</p>
                            ...
                            <form action="#">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" type="email" id="emailaddress1" required placeholder="Enter your email">
                                </div>
                                <div class="mb-2">
                    ...
                    <footer class="footer footer-alt">
                        <p class="text-muted">
                            ...
                            </script> &copy; Minton theme by <a href="javascript: void(0);" class="text-dark">Coderthemes</a>
                        </p>
                    </footer>
