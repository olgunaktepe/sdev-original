                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" type="email" id="emailaddress" required="" placeholder="Enter your email" value="minton@coderthemes.com" name="email">
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p><a href="{{ route('second', ['auth', 'recoverpw']) }}" class="text-muted ms-1">Forgot your password?</a></p>
                            <p class="text-muted">Don't have an account? <a href="{{ route('second', ['auth', 'register']) }}" class="text-primary fw-medium ms-1">Sign Up</a>
                            </p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
