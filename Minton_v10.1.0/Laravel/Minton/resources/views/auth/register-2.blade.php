...
<head>
    @include('layouts.shared/title-meta', ['title' => 'Register & Signup 2'])
            ...
            <div class="align-items-center d-flex h-100">
                <div class="card-body">
                    ...
                    <footer class="footer footer-alt">
                        <p class="text-muted">Already have account? <a href="{{ route('second', ['auth', 'login-2']) }}" class="text-primary fw-medium ms-1">Sign In</a></p>
                    </footer>
