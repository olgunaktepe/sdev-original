                        ...
                        <div class="d-flex align-items-start">
                            <div dir="ltr">
                                <input data-plugin="knob" data-width="64" data-height="64" data-fgColor="#675db7"
                                    data-bgColor="#e8e7f4" value="80" data-skin="tron" data-angleOffset="180"
                        ...
                        <div class="d-flex align-items-start">
                            <div dir="ltr">
                                <input data-plugin="knob" data-width="64" data-height="64" data-fgColor="#23b397"
                                    data-bgColor="#c8ece5" value="77" data-skin="tron" data-angleOffset="180"
                                    data-readOnly=true data-thickness=".15" />
                            </div>
                            <div class="flex-1 text-end align-self-center">
                        ...
                        <div class="d-flex align-items-start">
                            <div dir="ltr">
                                <input data-plugin="knob" data-width="64" data-height="64" data-fgColor="#ffbd4a"
                                    data-bgColor="#FFE6BA" value="35" data-skin="tron" data-angleOffset="180"
                                    data-readOnly=true data-thickness=".15" />
                            </div>
                            <div class="flex-1 text-end align-self-center">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="widget-chart text-center">
                                <div id="sparkline3" data-colors="#e3eaef,#3bafda,#1abc9c,#f1556c" class="text-center">
                                </div>
                                <div class="row mt-3">
                                    <div class="col-4">
                                        <p class="text-muted font-15 mb-1 text-truncate">Target</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="inbox-widget" data-simplebar style="max-height: 407px;">
                                ...
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/images/users/avatar-6.jpg"
                                            class="rounded-circle" alt=""></div>
                            ...
                            <div class="chat-conversation">
                                ...
                                <form class="needs-validation" novalidate name="chat-form" id="chat-form">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <button type="submit"
                                                class="btn btn-primary chat-send width-sm waves-effect waves-light">Send</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form name="todo-form" id="todo-form" class="needs-validation mt-3" novalidate>
                                    <div class="row">
                                        ...
                                        <div class="col-auto d-grid">
                                            <button class="btn btn-primary btn-md width-sm waves-effect waves-light"
