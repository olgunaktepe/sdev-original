                ...
                <div class="p-2">
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                ...
                                <img src="/images/users/avatar-10.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                <span class="user-status"></span>
                                <img src="/images/users/avatar-1.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                            <div class="flex-1 overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                ...
                                <img src="/images/users/avatar-9.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                            <div class="flex-1 overflow-hidden">
                ...
                <div class="p-2 pb-4">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                ...
                                <img src="/images/users/avatar-4.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                            <div class="flex-1 overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                <span class="user-status online"></span>
                                <img src="/images/users/avatar-5.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                            <div class="flex-1 overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                <span class="user-status busy"></span>
                                <img src="/images/users/avatar-7.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                            <div class="flex-1 overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start">
                            <div class="position-relative me-2">
                                <span class="user-status away"></span>
                                <img src="/images/users/avatar-8.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                            </div>
                            <div class="flex-1 overflow-hidden">
            ...
            <div class="tab-pane active" id="settings-tab" role="tabpanel">
                ...
                <div class="p-3">
                    ...
                    <div class="d-grid mt-4">
                        ...
                        <a href="#" class="btn btn-danger mt-2" target="_blank"><i class="mdi mdi-basket me-1"></i> Purchase Now</a>
                    </div>
