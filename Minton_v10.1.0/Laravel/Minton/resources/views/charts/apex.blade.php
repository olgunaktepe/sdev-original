@extends('layouts.vertical', ['page_title' => 'Apexcharts', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="cardCollpase18" class="collapse pt-3 show" dir="ltr">
                        <div id="apex-pie-1" class="apex-charts" data-colors="#3bafda,#1abc9c,#f7b84b,#6559cc,#f672a7">
                        </div>
                    </div> <!-- collapsed end -->
                </div> <!-- end card-body -->
            </div> <!-- end card-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="cardCollpase19" class="collapse pt-3 show" dir="ltr">
                        <div id="apex-pie-2" class="apex-charts" data-colors="#3bafda,#1abc9c,#f7b84b,#6559cc,#f672a7">
                        </div>
                    </div> <!-- collapsed end -->
                </div> <!-- end card-body -->
            </div> <!-- end card-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="cardCollpase20" class="collapse pt-3 show" dir="ltr">
                        <div id="apex-pie-3" class="apex-charts" data-colors="#3bafda,#1abc9c,#f7b84b,#6559cc,#f672a7">
                        </div>
                    </div> <!-- collapsed end -->
                </div> <!-- end card-body -->
            </div> <!-- end card-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="cardCollpase22" class="collapse pt-3 show" dir="ltr">
                        <div id="apex-radialbar-2" class="apex-charts" data-colors="#3bafda,#f672a7,#1abc9c,#f7b84b">
                        </div>
                    </div> <!-- collapsed end -->
                </div> <!-- end card-body -->
            </div> <!-- end card-->
