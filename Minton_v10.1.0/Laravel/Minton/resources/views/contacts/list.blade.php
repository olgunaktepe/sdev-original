@extends('layouts.vertical', ['page_title' => 'Contacts & Members Listing', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <img src="/images/users/avatar-3.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Denver Barker</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Robert McBride</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <img src="/images/users/avatar-4.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Peter White</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <img src="/images/users/avatar-5.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Ronald Myrick</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <img src="/images/users/avatar-6.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Paul Halpern</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <img src="/images/users/avatar-7.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Ricky Atwell</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">James Richards</a></h4>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="text-center card">
                <div class="card-body">
                    ...
                    <img src="/images/users/avatar-8.jpg" class="rounded-circle img-thumbnail avatar-xl mt-1" alt="profile-image">

                    <h4 class="mt-3 mb-1"><a href="{{ route('second', ['contacts', 'profile']) }}" class="text-dark">Charles Martinez</a></h4>
