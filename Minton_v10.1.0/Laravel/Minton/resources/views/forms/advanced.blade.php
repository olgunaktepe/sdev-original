@extends('layouts.vertical', ['page_title' => 'Advanced Form', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('css')
    @vite(['node_modules/mohithg-switchery/dist/switchery.min.css', 'node_modules/multiselect/css/multi-select.css', 'node_modules/select2/dist/css/select2.min.css', 'node_modules/selectize/dist/css/selectize.bootstrap3.css', 'node_modules/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css'])
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <h5 class="mt-0 font-14 mb-1">Default</h5>
                            <p class="text-muted font-13">
                                Use a <code>
                        ...
                        <div class="col-md-4">
                            <h5 class="mb-1 font-14 mt-3 mt-md-0 fw-medium">Grouped Options</h5>
                            <p class="text-muted font-13">
                                Use a <code>
                                    &lt;select multiple /&gt;</code>
                                as your input element for a tags input, to gain true multivalue support.
                        ...
                        <div class="col-md-4">
                            <h5 class="mb-1 mt-3 mt-md-0 font-14">Searchable</h5>
                            <p class="text-muted font-13">
                                Use a <code>
                                    &lt;select multiple /&gt;</code>
                                as your input element for a tags input, to gain true multivalue support.
