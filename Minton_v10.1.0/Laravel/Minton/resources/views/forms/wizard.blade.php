                    ...
                    <form>
                        <div id="basicwizard">
                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                ...
                                <li class="nav-item text-start">
                                    <a href="#basictab2" data-bs-toggle="tab" data-toggle="tab" class="nav-link">
                                        <span class="number">2</span>
                                        <span class="d-none d-sm-inline">Profile</span>
                                    </a>
                                </li>
                                <li class="nav-item text-start">
                                    <a href="#basictab3" data-bs-toggle="tab" data-toggle="tab" class="nav-link">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value="" id="terms-conditions-basicwizard">
                                                        <label class="form-check-label" for="terms-conditions-basicwizard">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="btnwizard">
                        <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                            <li class="nav-item text-start">
                                <a href="#tab12" data-bs-toggle="tab" data-toggle="tab" class="nav-link pt-2 pb-2">
                                    <span class="number">1</span>
                                    <span class="d-none d-sm-inline">Account</span>
                                </a>
                            </li>
                            <li class="nav-item text-start">
                                <a href="#tab22" data-bs-toggle="tab" data-toggle="tab" class="nav-link pt-2 pb-2">
                                    <span class="number">2</span>
                                    <span class="d-none d-sm-inline">Profile</span>
                                </a>
                            </li>
                            <li class="nav-item text-start">
                                <a href="#tab32" data-bs-toggle="tab" data-toggle="tab" class="nav-link pt-2 pb-2">
                                    <span class="number">3</span>
                                    <span class="d-none d-sm-inline">Finish</span>
                                </a>
                            </li>
                        ...
                        <div class="tab-content mb-0 b-0">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="text-center">
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check d-inline-block">
                                                    <input class="form-check-input" type="checkbox" value="" id="terms-conditions-buttonswizard">
                                                    <label class="form-check-label" for="terms-conditions-buttonswizard">
                                                        I agree with the Terms and Conditions
                                                    </label>
                                                </div>
                                            </div>
                            ...
                            <div class="float-start">
                                ...
                                <input type='button' class='btn btn-danger button-previous' name='previous' value='Previous' />
                            </div>
                    ...
                    <form>
                        <div id="progressbarwizard">
                            ...
                            <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                <li class="nav-item text-start">
                                    <a href="#account-2" data-bs-toggle="tab" data-toggle="tab" class="nav-link">
                                        <span class="number">1</span>
                                        <span class="d-none d-sm-inline">Account</span>
                                    </a>
                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="text-center">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check d-inline-block">
                                                        <input class="form-check-input" type="checkbox" value="" id="terms-conditions-progresswizard">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="rootwizard">
                        <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                            <li class="nav-item text-start" data-target-form="#accountForm">
                                <a href="#first" data-bs-toggle="tab" data-toggle="tab" class="nav-link">
                                    <span class="number">1</span>
                                    <span class="d-none d-sm-inline">Account</span>
                                </a>
                            </li>
                            <li class="nav-item text-start" data-target-form="#profileForm">
                                <a href="#second" data-bs-toggle="tab" data-toggle="tab" class="nav-link">
                                    <span class="number">2</span>
                                    <span class="d-none d-sm-inline">Profile</span>
                                </a>
                            </li>
                            <li class="nav-item text-start" data-target-form="#otherForm">
