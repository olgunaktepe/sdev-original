@extends('layouts.vertical', ['page_title' => 'Pickers', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('css')
    @vite(['node_modules/spectrum-colorpicker2/dist/spectrum.min.css', 'node_modules/clockpicker/dist/bootstrap-clockpicker.min.css', 'node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css', 'node_modules/bootstrap-daterangepicker/daterangepicker.css'])
@endsection
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="colorpicker-default" value="#3bafda">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Show Alpha</label>
                                <input type="text" class="form-control" id="colorpicker-showalpha" value="rgba(52, 195, 143, 0.6)">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="colorpicker-showintial" value="#6559cc">
                            </div>
                            <div>
                                <label class="form-label">Show Input And Initial</label>
                                <input type="text" class="form-control" id="colorpicker-showinput-intial" value="#37cde6">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="p-2">
                                <form action="#" class="form-horizontal">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group position-relative" id="datepicker1">
                                                <input type="text" class="form-control" data-provide="datepicker" data-date-format="dd M, yyyy" data-date-container="#datepicker1">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group position-relative" id="datepicker3">
                                                <input type="text" class="form-control" data-provide="datepicker" data-date-format="dd M, yyyy" data-date-multidate="true" data-date-container="#datepicker3">
                                                <span class="input-group-text"><i class="ri-calendar-event-fill"></i></span>
                                            </div><!-- input-group -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group position-relative" id="datepicker4">
                                                <input type="text" class="form-control" data-provide="datepicker" data-date-format="MM yyyy" data-date-min-view-mode="1" data-date-container="#datepicker4">
                                            </div><!-- input-group -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group position-relative" id="datepicker5">
                                                <input type="text" class="form-control" data-provide="datepicker" data-date-format="dd M, yyyy" data-date-min-view-mode="2" data-date-container="#datepicker5">
                                            </div><!-- input-group -->
                                        </div>
                                    </div>
