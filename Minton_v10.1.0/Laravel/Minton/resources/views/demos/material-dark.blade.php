@extends('layouts.vertical', ['page_title' => 'Sales Dashboard', 'mode' => $mode ?? '', 'demo' => $demo ?? 'material', 'theme' => $theme ?? 'dark'])
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="knob-chart" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#0056c1" data-bgColor="#d6e5f7" value="80" data-skin="tron" data-angleOffset="0" data-readOnly=true data-thickness=".15" />
                        </div>
                        <div class="text-end">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div dir="ltr">
                            <div id="revenue-report" class="apex-charts" data-colors="#0056c1,#e3eaef"></div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div dir="ltr">
                            <div id="products-sales" class="apex-charts" data-colors="#0056c1,#1abc9c"></div>
                        </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="marketing-reports" class="apex-charts" data-colors="#0056c1,#1abc9c,#f7b84b"></div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center" dir="ltr">
                        ...
                        <div id="projections-actuals" class="apex-charts" data-colors="#0056c1,#1abc9c,#f7b84b,#f672a7"></div>
