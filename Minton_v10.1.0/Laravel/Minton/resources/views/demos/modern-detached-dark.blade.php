@extends('layouts.detached', ['page_title' => 'Sales Dashboard', 'mode' => $mode ?? '', 'demo' => $demo ?? 'modern', 'theme' => $theme ?? 'dark'])
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="knob-chart" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#18c984" data-bgColor="#d1f2eb" value="58" data-skin="tron" data-angleOffset="0" data-readOnly=true data-thickness=".15" />
                        </div>
                        <div class="text-end">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="knob-chart" dir="ltr">
                            <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#526dee" data-bgColor="#d4dbfd" value="80" data-skin="tron" data-angleOffset="0" data-readOnly=true data-thickness=".15" />
                        </div>
                        <div class="text-end">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div dir="ltr">
                            <div id="revenue-report" class="apex-charts" data-colors="#526dee,#e3eaef"></div>
                        </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="marketing-reports" class="apex-charts" data-colors="#526dee,#1abc9c,#f4bf3e"></div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div dir="ltr">
                            <div id="products-sales" class="apex-charts" data-colors="#526dee,#eb5151"></div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center" dir="ltr">
                        ...
                        <div id="projections-actuals" class="apex-charts" data-colors="#526dee,#18c984,#f4bf3e,#f672a7"></div>
