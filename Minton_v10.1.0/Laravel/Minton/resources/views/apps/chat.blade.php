                    ...
                    <div class="d-flex align-items-start align-items-start mb-3">
                        ...
                        <div class="flex-1">
                            <h5 class="mt-0 mb-0 font-15">
                                <a href="{{ route('second', ['contacts', 'profile']) }}" class="text-reset">Nik Patel</a>
                            </h5>
                            ...
                            <div data-simplebar style="max-height: 498px">
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            ...
                                            <img src="/images/users/avatar-2.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            ...
                                            <img src="/images/users/avatar-5.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-14">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            ...
                                            <img src="/images/users/avatar-7.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-14">
                                            ...
                                            <p class="mt-1 mb-0 text-muted font-14">
                                                ...
                                                <span class="w-75">Are we going to have this week's planning meeting
                                                    today?</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            <span class="user-status online"></span>
                                            <img src="/images/users/avatar-8.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-14">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            ...
                                            <img src="/images/users/avatar-3.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-14">
                                            ...
                                            <p class="mt-1 mb-0 text-muted font-14">
                                                <span class="w-75">Are you free for 15 min? I would like to discuss
                                                    something...</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            <span class="user-status"></span>
                                            <img src="/images/users/avatar-6.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-14">
                                                <span class="float-end text-muted fw-normal font-12">Tue</span>
                                            ...
                                            <p class="mt-1 mb-0 text-muted font-14">
                                                <span class="w-75">Let's have meeting today between me, you and
                                                    Tony...</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <div class="position-relative">
                                            <span class="user-status online"></span>
                                            <img src="/images/users/avatar-4.jpg" class="me-2 rounded-circle" height="42" alt="user" />
                                        </div>
                                        <div class="flex-1">
                                            <h5 class="mt-0 mb-0 font-14">
            ...
            <div class="card">
                <div class="card-body py-2 px-3 border-bottom border-light">
                    <div class="d-flex py-1">
                        <img src="/images/users/avatar-5.jpg" class="me-2 rounded-circle" height="36" alt="Brandon Smith">
                        <div class="flex-1">
                            <h5 class="mt-0 mb-0 font-15">
                    ...
                    <ul class="conversation-list chat-app-conversation" data-simplebar style="max-height: 460px">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="/images/users/avatar-5.jpg" class="rounded" alt="James Z" />
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="/images/users/avatar-1.jpg" class="rounded" alt="Nik Patel" />
                                <i>10:01</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
                        ...
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="/images/users/avatar-5.jpg" alt="James Z" class="rounded" />
                                <i>10:02</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="/images/users/avatar-1.jpg" alt="Nik Patel" class="rounded" />
                                <i>10:03</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
