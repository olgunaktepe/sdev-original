...
$(function() {
  var $offcanvas = $('#theme-settings-offcanvas');
  ...
  // 2) Prevent clicks inside the offcanvas from bubbling up
  $offcanvas.on('click', function(e) {
    e.stopPropagation();
  });

  // 3) Clicks anywhere else hide it
  ...
  function showBackdrop() {
    if (!$('#custom-backdrop').length) {
      const backdrop = $('<div id="custom-backdrop" class="offcanvas-backdrop fade show"></div>');
