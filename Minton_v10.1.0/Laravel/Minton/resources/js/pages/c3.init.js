...
!function($) {
    ...
    ChartC3.prototype.init = function () {
        //generating chart 
        var colors = ['#e3eaef','#1abc9c', '#3bafda'];
        ...
        //combined chart
        var colors = ['#e3eaef','#3bafda', '#f672a7', '#6559cc', '#1abc9c'];
        ...
        //Donut Chart
        var colors = ["#e3eaef", "#3bafda", "#1abc9c"];
        ...
        //Pie Chart
        var colors = ["#3bafda", "#e3eaef", "#1abc9c"];
        ...
        //Scatter Plot
        var colors = ["#3bafda", "#1abc9c", "#3bafda", "#1abc9c"];
