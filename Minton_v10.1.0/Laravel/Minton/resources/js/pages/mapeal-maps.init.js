...
import './mousewheel.min';

import 'jquery-mapael/js/maps/world_countries.min.js';
import 'jquery-mapael/js/maps/usa_states.min.js';
...
document.addEventListener('DOMContentLoaded', function () {
  $(function () {
    ...
    // Zoom on mousewheel.min.js with mousewheel.min.js jQuery plugin
    // $mapusa.on("mousewheel.min.js", function (e) {
    //     if (e.deltaY > 0) {
    ...
    $(".mapcontainer").mapael({
      ...
      links: {
        'link1': {
          ...
          factor: -0.3, between: [{ latitude: 24.708785, longitude: -5.402427 }, { x: 560, y: 280 }],
          attrs: {
            "stroke-width": 2
        ...
        'parisnewyork': {
          ...
          factor: -0.3, between: ['paris', 'newyork'], attrs: {
            "stroke-width": 2
          },
          tooltip: { content: "Paris - New-York" }
        }, 'parissanfrancisco': {
          // The curve can be inverted by setting a negative factor
          factor: -0.5, between: ['paris', 'sanfrancisco'], attrs: {
            "stroke-width": 4
          },
          tooltip: { content: "Paris - San - Francisco" }
        },
        'parisbrasilia': {
          factor: -0.8, between: ['paris', 'brasilia'], attrs: {
            "stroke-width": 1
          }, tooltip: { content: "Paris - Brasilia" }
        },
        'romamiami': {
          factor: 0.2, between: ['roma', 'miami'], attrs: {
            "stroke-width": 4
          }, tooltip: { content: "Roma - Miami" }
        },
        'sydneyplot1': {
          factor: -0.2, between: ['sydney', 'plot1'], attrs: {
            stroke: "#6658dd",
            "stroke-width": 3,
        ...
        'sydneyplot2': {
          factor: -0.1, between: ['sydney', 'plot2'], attrs: {
            stroke: "#6658dd",
            "stroke-width": 8,
            "stroke-linecap": "round",
            opacity: 0.6
        ...
        'sydneyplot3': {
          factor: 0.2, between: ['sydney', 'plot3'], attrs: {
            stroke: "#6658dd",
            "stroke-width": 4,
            "stroke-linecap": "round",
            opacity: 0.6
        ...
        'sydneytokyo': {
          factor: 0.2, between: ['sydney', 'tokyo'], attrs: {
            stroke: "#6658dd",
            "stroke-width": 6,
            "stroke-linecap": "round",
            opacity: 0.6
