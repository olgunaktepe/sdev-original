...
const MDIICONS_LIST: MdiIconType[] = [
  {
    name: "ab-testing",
    hex: "F01C9",
    version: "4.0.96",
...
const ICONSIZE_LIST: number[] = [18, 24, 36, 48];
const ROTATEICON_LIST: number[] = [45, 90, 135, 180, 225, 270, 315];
const SPINICON_LIST: string[] = ["loading", "star"];

export { MDIICONS_LIST, ICONSIZE_LIST, ROTATEICON_LIST, SPINICON_LIST };
