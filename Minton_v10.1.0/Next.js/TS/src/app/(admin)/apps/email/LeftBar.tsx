  ...
  return (
    <div className="inbox-leftbar">
      ...
      <div className="mail-list mt-4">
        <Link href="" className="text-danger" onClick={showAllEmails}>
      ...
      <div className="list-group b-0 mail-list">
        <Link href="" className="list-group-item border-0">
      ...
      {/* compose email modal */}
      {isOpen && (
        <ComposeEmail isOpen={isOpen} toggleComposeModal={toggleComposeModal} />
      )}
    </div>
  );
};
