...
const Header = () => {
    ...
    return (
        <ul className="nav-justified twitter-bs-wizard-nav mb-2 nav nav-pills" role="tablist">
            <li className="nav-item" role="presentation">
                <button onClick={() => goToStep(0)} type="button"
                        className={`nav-link ${activeStep === 0 && 'active'}`}><span className="number">01</span><span
                    className="d-none d-sm-inline">Billing Info</span></button>
            </li>
            <li className="nav-item" role="presentation">
                <button onClick={() => goToStep(1)} type="button"
                        className={`nav-link ${activeStep === 1 && 'active'}`}><span className="number">02</span><span
                    className="d-none d-sm-inline">Shipping Info</span></button>
            </li>
            <li className="nav-item" role="presentation">
                <button onClick={() => goToStep(2)} type="button"
                        className={`nav-link ${activeStep === 2 && 'active'}`}><span className="number">03</span><span
                    className="d-none d-sm-inline">Payment Info</span></button>
            </li>
        </ul>
    )
}
        ...
        <>
            ...
            <ul className="pager wizard list-inline mt-2">
                <li className="list-inline-item">
                    <Link
                        href="/apps/ecommerce/shopping-cart"
...
const Step2 = ({updateShipping}: { updateShipping: (shippingCost: number) => void }) => {
