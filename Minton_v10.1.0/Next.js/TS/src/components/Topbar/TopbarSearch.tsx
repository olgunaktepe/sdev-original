            ...
            <div className="notification-list">
              <Dropdown.Item className="notify-item">
                <div className="d-flex">
                  <Image className="d-flex me-2 rounded-circle" src={avatar2} alt="Generic placeholder" height={32} width={32} />
                  <div>
              ...
              <Dropdown.Item className="notify-item">
                <div className="d-flex">
                  <Image className="d-flex me-2 rounded-circle" src={avatar5} alt="Generic placeholder" height={32} width={32} />
                  <div>
