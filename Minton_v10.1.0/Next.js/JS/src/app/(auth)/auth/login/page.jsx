...
const Login = () => {
  ...
  return <AuthLayout helpText="Enter your email address and password to access admin panel." bottomLinks={<BottomLink />}>
            ...
            <form onSubmit={login}>
                <FormInput type="email" name="email" label="Email address" placeholder="user@coderthemes.com" containerClass={"mb-2"} control={control} />
                <FormInput label="Password" type="password" name="password" placeholder="Enter your password" containerClass={"mb-2"} control={control}></FormInput>
