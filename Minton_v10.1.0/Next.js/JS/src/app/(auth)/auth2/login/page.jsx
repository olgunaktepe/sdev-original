...
const BottomLink = () => {
  return <footer className="footer footer-alt">
            <p className="text-muted">
                ...
                <Link href={"/auth2/register"} className="text-muted ms-1">
                    <b>Sign Up</b>
                </Link>
            </p>
        </footer>;
...
const Login2 = () => {
  return <AuthLayout2 bottomLinks={<BottomLink />}>
            ...
            <form>
                <FormInput type="email" name="email" label="Email address" placeholder="hello@coderthemes.com" containerClass={"mb-2"} />
                <FormInput label="Password" type="password" name="password" placeholder="Enter your password" containerClass={"mb-2"}>
                    <Link href="/auth2/forget-password" className="text-muted float-end">
