...
const BottomLink = () => {
  return <footer className="footer footer-alt">
      <p className="text-muted">
        ...
        <Link href="https://coderthemes.com/" className="text-muted" target="_blank">
          Coderthemes
        </Link>
      </p>
    </footer>;
  ...
  return <>
      <AuthLayout2 bottomLinks={<BottomLink />}>
        <div className="text-center">
          <Image src={mailSent} alt="mail" height={120} width={120} />
          <h3>Success !</h3>
          ...
          <Link href="/auth2/login" className="btn w-100 btn-primary waves-effect waves-light mt-3">
            Back to Home{" "}
          </Link>
        </div>
      </AuthLayout2>
