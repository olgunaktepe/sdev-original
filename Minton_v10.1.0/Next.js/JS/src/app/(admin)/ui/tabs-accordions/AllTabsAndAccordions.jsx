...
import { Tab, Nav, Accordion, Button, Collapse } from "react-bootstrap";
...
const CustomCollapse = () => {
  ...
  return <>
      <div className="d-flex gap-2 mb-2">
        <Link href="" className="btn btn-primary waves-effect waves-light" onClick={toggle}>
          Link with href
        </Link>
...
const HorizontalCollapse = () => {
  ...
  return <>
      ...
      <Collapse in={open} dimension="width">
        <div>
          <div className="card card-body mb-0" style={{
          width: "450px"
        }}>
