  ...
  return <div className="card">
      <div className="card-body">
        ...
        <Carousel indicators={false} controls={false}>
          <Carousel.Item>
            <Image className="d-block img-fluid" src={small1.src} alt="First slide" width={900} height={600} />
          </Carousel.Item>
          <Carousel.Item>
            <Image className="d-block img-fluid" src={small2.src} alt="Second slide" width={900} height={600} />
          </Carousel.Item>
          <Carousel.Item>
            <Image className="d-block img-fluid" src={small3.src} alt="Third slide" width={900} height={600} />
          </Carousel.Item>
        </Carousel>
      </div>
    </div>;
  ...
  return <div className="card">
      <div className="card-body">
        ...
        <Carousel indicators={false}>
          <Carousel.Item>
            <Image className="d-block w-100" src={small1.src} alt="First slide" width={900} height={600} />
          </Carousel.Item>
          <Carousel.Item>
            <Image className="d-block w-100" src={small2.src} alt="Second slide" width={900} height={600} />
          </Carousel.Item>
          <Carousel.Item>
            <Image className="d-block w-100" src={small3.src} alt="Third slide" width={900} height={600} />
          </Carousel.Item>
        </Carousel>
      </div>
    </div>;
