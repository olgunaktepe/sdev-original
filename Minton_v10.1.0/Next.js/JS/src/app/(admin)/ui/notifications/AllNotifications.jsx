...
import { Toast, ToastContainer, Form, Button, Alert } from "react-bootstrap";
          ...
          <div className="col-md-6">
            ...
            <div className="p-3">
              <Toast onClose={() => setShow(false)} show={show} delay={8000} autohide>
                <Toast.Header>
                  <Image src={user} alt="brand-logo" className="me-1 rounded" height={28} width={28} />
          ...
          <div className="col-md-6">
            ...
            <div className="p-3 bg-light">
              <Toast onClose={() => setShowTranslucent(false)} show={showTranslucent} delay={5000} autohide>
                <Toast.Header>
                  <Image src={user2} alt="brand-logo" className="me-1" height={28} width={28} />
              ...
              minHeight: "200px"
                ...
                right: 0
                  ...
                  return <Toast key={index} onClose={() => handleClose(index)} delay={7000} autohide>
                        <Toast.Header>
                          <Image src={item.avatar} alt="brand-logo" className="me-1 rounded" height={28} width={28} />
            ...
            <div className="p-3">
              ...
              minHeight: "200px"
                ...
                <Toast onClose={() => setShowPlacement(false)} show={showPlacement}>
                  <Toast.Header>
                    <Image src={user4} alt="brand-logo" className="me-1 rounded" height={28} width={28} />
            ...
            <ToastContainer className="p-3" position={position}>
              <Toast>
                <Toast.Header closeButton={false}>
                  <Image src={user4} className="me-1 rounded" alt="" height={28} width={28} />
                  <strong className="me-auto">Ronnie</strong>
                  <small>11 mins ago</small>
                </Toast.Header>
                <Toast.Body>Hello, world! This is a toast message.</Toast.Body>
