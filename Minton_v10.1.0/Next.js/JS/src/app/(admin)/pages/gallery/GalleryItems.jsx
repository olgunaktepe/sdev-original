...
const GalleryItems = () => {
  ...
  const filterImages = category => {
    ...
    setTimeout(() => {
      const galleryAlbums = category === "all" ? data : data.filter(album => album.category?.includes(category));
  ...
  return <>
        ...
        <div className="col-xs-12">
          <div className="text-center filter-menu">
            <Link href="" className={classNames("filter-menu-item", "me-1", {
            active: category === "all"
      ...
      <div className="row filterable-content position-relative">
        ...
        return <div className="col-sm-6 col-xl-3 filter-item all illustrator" key={index}>
              <div className="gal-box">
                <Link href="" className="image-popup" onClick={openLightbox}>
                ...
                <div className="gall-info">
                  ...
                  <Link href="">
                    <Image src={item.avatar} alt="user-img" className="rounded-circle" height={24} width={24} />
      ...
      {/* image lightbox */}
        <Lightbox open={isOpen} close={() => setIsOpen(false)} slides={galleryImages} />
