...
const allResults = [{
  ...
  content: `<div class="d-flex">
            <img class="d-flex me-3 rounded-circle" src="${user1.src}" alt="Generic placeholder image" height="54">
            <div class="flex-1">
                <h5 class="mt-0">
  ...
  content: `
        <div class="">
        <img src="${img1.src}" height="48" alt="image"/>
        <img src="${img2.src}" height="48" alt="image"/>
        <img src="${img3.src}" height="48" alt="image"/>
        <img src="${img4.src}" height="48" alt="image"/>
        </div>`
}, {
  id: 6,
  title: "Coderthemes - WrapBootstrap",
  url: "https://wrapbootstrap.com/theme/minton-admin-dashboard-template-WB0858DB6?ref=coderthemes",
  content: `
