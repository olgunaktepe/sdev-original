...
const RequestedBy = ({
  ...
  return <>
      <Link href="" className="text-dark">
        <Image src={row.original.requested_by.image} alt="avatar" title="contact-img" className="avatar-sm rounded-circle img-thumbnail" height={36} width={36} />
...
const AssigneeColumn = ({
  ...
  return <>
      <Link href="">
        <Image src={row.original.assignee} alt="avatar" title="contact-img" className="avatar-sm rounded-circle img-thumbnail" height={36} width={36} />
      </Link>
    </>;
};
...
const ActionColumn = () => {
  return <Dropdown className="btn-group" align="end">
  ...
  return <>
      <div className="card">
        <div className="card-body">
          <Table columns={columns} data={ticketDetails} pageSize={10} sizePerPageList={sizePerPageList} isSortable={true} pagination={true} isSearchable={true} theadClass="bg-light" searchBoxClass="mt-2 mb-3" />
        </div>
      </div>
    </>;
};
