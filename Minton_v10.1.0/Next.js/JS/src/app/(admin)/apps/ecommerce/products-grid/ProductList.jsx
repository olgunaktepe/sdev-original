      ...
      <div className="product-info border-top p-3">
        <div>
          ...
          <p className="text-muted">
            {(Array(rating) || []).map((x, i) => <i key={i} className="mdi mdi-star text-warning"></i>)}
            {(Array(emptyStars) || []).map((x, i) => <i key={i} className="mdi mdi-star"></i>)}
          </p>
          <h4 className="m-0">
...
const ProductList = () => {
  ...
  return <>
      ...
      <div className="row">
        ...
        return <div className="col-md-6 col-xl-3" key={index}>
