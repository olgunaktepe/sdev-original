      ...
      <Table responsive borderless className="table-centered mb-0">
        ...
        <tbody>
          {(items || []).map((item, idx) => {
            return <tr key={idx}>
                <td>
                  <Image src={item.image} alt={item.name} title="product-img" className="avatar-lg" height={72} width={72} />
                </td>
                <td>
                  <h5 className="mt-0 mb-1 text-truncate">
                    <Link href="/apps/ecommerce/product-detail" className="text-body">
                      {item.name}
                    </Link>
                  </h5>
                  <p className="mb-0">
                ...
                <td>${item.total}</td>
                <td>
                  <Link href="" className="action-icon text-danger" onClick={e => {
                  removeItem(e, item);
                }}>
                    {" "}
