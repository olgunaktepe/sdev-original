...
const FileList = () => {
  return <Table responsive className="table-centered table-nowrap mb-0">
      ...
      <tbody>
        ...
        return <tr key={i}>
              <td>
                <Image src={item.file_icon} height={30} width={30} alt="" className="me-2" />{" "}
              ...
              return <Image src={user} key={i} alt="avatar" className="avatar-sm img-thumbnail rounded-circle" height={36} width={36} />;
            })}
              </td>
              <td>
