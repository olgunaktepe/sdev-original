...
const Widgets = () => {
  return <>
      ...
      <div className="row">
        ...
        <div className="col-xl-3 col-md-6">
          <Statistics variant="pink" description="Total Earning" counterOptions={{
          prefix: "$ "
        }} stats="12480" />
        </div>
        <div className="col-xl-3 col-md-6">
      ...
      <div className="row">
        <div className="col-xl-3 col-md-6">
          <Statistics2 variant="success" description="Today's Visits" icon="mdi mdi-android-studio" stats="64570" />
        </div>
        <div className="col-xl-3 col-md-6">
        ...
        <div className="col-xl-3 col-md-6">
          <Statistics2 variant="purple" description="Conversion" icon="mdi mdi-barley" counterOptions={{
          suffix: "%",
          decimals: 2
        }} stats="0.16" />
        </div>
      ...
      <div className="row">
        ...
        <div className="col-xl-3 col-md-6">
          <Statistics2 variant="pink" description="Conversion" icon="mdi mdi-clock" counterOptions={{
          suffix: "%",
          decimals: 2
        }} stats="0.65" />
        </div>
      ...
      <div className="row">
        <div className="col-xl-3 col-md-6">
          <StatisticsChartWidget hasHeader title={"New Customers"} color={"#f05050"} data={58} stats={"268"} description={"Since last week"} />
        </div>
        <div className="col-xl-3 col-md-6">
          <StatisticsChartWidget hasHeader title={"Online Orders"} color={"#675db7"} data={80} stats={"8715"} description={"Since last month"} />
        </div>
        <div className="col-xl-3 col-md-6">
          <StatisticsChartWidget hasHeader title={"Revenue"} color={"#23b397"} data={77} stats={"$925"} description={"This week"} />
        </div>
        <div className="col-xl-3 col-md-6">
          <StatisticsChartWidget hasHeader title={"Daily Average"} color={"#ffbd4a"} data={35} stats={"$78.58"} description={"Revenue today "} />
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-xl-3 col-md-6">
          <ProfileCard avatar={user1.src} name="Chadengle" email="coderthemes@gmail.com" role="Admin" variant="warning" />
        </div>
        <div className="col-xl-3 col-md-6">
          <ProfileCard avatar={user2.src} name="Tomaslau" email="coderthemes@gmail.com" role="User" variant="success" />
        </div>
        <div className="col-xl-3 col-md-6">
          <ProfileCard avatar={user3.src} name="Stillnotdavid" email="coderthemes@gmail.com" role="Admin" variant="pink" />
        </div>
        <div className="col-xl-3 col-md-6">
          <ProfileCard avatar={user4.src} name="Arashasghari" email="coderthemes@gmail.com" role="User" variant="info" />
        </div>
      </div>

      <div className="row">
        <div className="col-xl-3 col-md-6">
          <Statistics3 icon="mdi mdi-coffee" variant="primary" title="New User" stats="8541" trend={{
          value: "39% Up",
          variant: "success"
        }} />
        </div>
        <div className="col-xl-3 col-md-6">
          <Statistics3 icon="mdi mdi-contrast-circle" variant="warning" title="New ORDERS" stats="6521" trend={{
          value: "56% Down",
          variant: "danger"
        }} />
        </div>
        <div className="col-xl-3 col-md-6">
          <Statistics3 icon="mdi mdi-crown" variant="success" title="Bug Reports" stats="1452" trend={{
          value: "0%",
          variant: "info"
        }} />
        </div>
        <div className="col-xl-3 col-md-6">
          <Statistics3 icon="mdi mdi-download" variant="pink" title="Total Downloads" stats="562" trend={{
          value: "39% Up",
          variant: "success"
        }} />
        </div>
