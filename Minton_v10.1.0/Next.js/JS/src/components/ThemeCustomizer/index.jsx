...
const ThemeCustomizer = () => {
  ...
  return <React.Fragment>
            ...
            <div className="p-3">
                ...
                {orientation != "horizontal" && <MenuPositions />}

                <MenuTheme />

                {orientation != "horizontal" && <MenuSize />}

                {orientation != "horizontal" && <SidebarUserInfo />}

                <div className="d-grid mt-4">
                    <button className="btn btn-primary" id="resetBtn" onClick={() => resetSettings()}>
                        Reset to Default
                    </button>
                    <Link href="https://wrapbootstrap.com/theme/minton-admin-dashboard-template-WB0858DB6?ref=coderthemes" className="btn btn-danger mt-2" target="_blank">
