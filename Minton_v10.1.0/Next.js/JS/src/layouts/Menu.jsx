...
const MenuItemWithChildren = ({
  ...
  return <li className={classNames("side-nav-item", {
    "menuitem-active": open
      ...
      <Link href="" onClick={toggleMenuItem} data-menu-key={item.key} aria-expanded={open} className={classNames("has-arrow", "side-sub-nav-link", linkClassName, {
...
const MenuItemLink = ({
  ...
  return <Link href={item.url} target={item.target} className={classNames("side-nav-link-ref", "side-sub-nav-link", className)} data-menu-key={item.key}>
      {item.icon && <i className={item.icon} />}
