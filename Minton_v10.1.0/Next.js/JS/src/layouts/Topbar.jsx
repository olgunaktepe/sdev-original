  ...
  return <React.Fragment>
            <div className={`navbar-custom ${navbarCssClasses}`}>
                ...
                <span className="logo-sm">
                  ...
                  <Image src={orientation === 'two-column' ? logoDark2 : logoDark} alt="logo" height={20} width={108} />
                </span>
                            </Link>
                ...
                <span className="logo-sm">
                  <Image src={logoSm} alt="" height={24} width={24} />
                                ...
                                <span className="logo-lg">
                  <Image src={orientation === 'two-column' ? logoLight2 : logoLight} alt="logo" height={20} width={108} />
                </span>
                            </Link>
                        </div>}
              ...
              <span className="nav-link dropdown-toggle arrow-none waves-effect waves-light" onClick={toggleDarkMode}>
                <i className="fe-moon noti-icon" />
                        ...
                        <li className="dropdown notification-list">
                            <Link href="" className="nav-link dropdown-toggle right-bar-toggle waves-effect waves-light" onClick={themeCustomizer.toggle}>
                    ...
                    <ul className="list-unstyled topnav-menu topnav-menu-left m-0">
                        ...
                        <li>
                            <Link href="" className={classNames("navbar-toggle nav-link", {
              open: isopen
