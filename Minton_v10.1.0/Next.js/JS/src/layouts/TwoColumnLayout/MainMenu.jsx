...
const MenuItemWithChildren = ({
  ...
  return <>
      ...
      "menuitem-active": open
                ...
                <Link href="" onClick={toggleMenuItem} data-menu-key={item.key} aria-expanded={open} className={classNames("nav-link", linkClassName, {
...
const MenuItemLink = ({
  ...
  return <Link href={item.url} target={item.target} className={classNames("nav-link-ref", "nav-link", className)} data-menu-key={item.key}>
