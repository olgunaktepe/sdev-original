      ...
      >
        <Row>
          ...
          <Col>
            <button
              type="submit"
              className="btn btn-primary chat-send width-sm waves-effect waves-light"
            >
              Send
            </button>
          </Col>
      ...
      <Card>
        <CardBody>
          <Dropdown className="float-end" align="end">
            <Dropdown.Toggle
              as="a"
              className="cursor-pointer arrow-none card-drop"
            >
          ...
          <div className="chat-conversation">
            {/* chat messages */}
            <SimpleBar style={{ maxHeight: "358px", width: "100%" }}>
