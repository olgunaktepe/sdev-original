    ...
    return (
        <>
            ...
            <Form.Check className="form-check form-switch mb-1">
                <Form.Check.Input
                    type="radio"
                    onChange={() => changeLayoutOrientation('vertical')}
                    name="layout-type"
                    value="vertical"
                    id="vertical-layout"
            ...
            <Form.Check className="form-check form-switch mb-1">
                <Form.Check.Input
                    type="radio"
                    onChange={() => changeLayoutOrientation('horizontal')}
                    name="layout-type"
                    value="horizontal"
            ...
            <Form.Check className="form-check form-switch mb-1">
                <Form.Check.Input
                    type="radio"
                    onChange={() => changeLayoutOrientation('detached')}
                    name="layout-type"
                    value="detached"
                    id="detached-layout"
                    checked={orientation === 'detached'}
                />
            ...
            <Form.Check className="form-check form-switch mb-1">
                <Form.Check.Input
                    type="radio"
                    onChange={() => changeLayoutOrientation('two-column')}
                    name="layout-type"
                    value="two-column"
