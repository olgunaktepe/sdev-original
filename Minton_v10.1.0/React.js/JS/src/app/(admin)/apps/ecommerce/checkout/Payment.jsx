  ...
  return <div>
            ...
            <div className="border p-3 mb-3 rounded">
                ...
                <form onSubmit={handleSubmit(() => {})} className="mt-4" noValidate>
                    <Row>
                        <Col md={12}>
                            <FormInput name="card-number" label="Card Number" type="text" placeholder="4242 4242 4242 4242" containerClass={"mb-2"} register={register} key="notes" errors={errors} control={control} />
                        </Col>
                    </Row>

                    <Row>
                        <Col md={6}>
                            <FormInput name="name" label="Name on card" type="text" placeholder="Master name" containerClass={"mb-2"} register={register} key="notes" errors={errors} control={control} />
                        </Col>
                        <Col md={3}>
                            <div className="mb-2">
                                <label className="form-label">Expiry date</label>
                                <InputMask mask="__/__" replacement={{
                _: /\d/
              }} placeholder="MM/YY" className="form-control" />
                            </div>
                        </Col>
                        <Col md={3}>
                            <div className="mb-2">
                                <label className="form-label">CVV code</label>
                                <InputMask mask="___" replacement={{
                _: /\d/
              }} placeholder="xxx" className="form-control" />
                            </div>
                        </Col>
                    </Row>
                </form>
