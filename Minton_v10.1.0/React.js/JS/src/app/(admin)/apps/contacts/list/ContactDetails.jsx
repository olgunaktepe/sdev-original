        ...
        return <Col xl={3} sm={6} key={index}>
                            <Card className="text-center">
                                <Card.Body>
                                    ...
                                    {user.avatar ? <img src={user.avatar} className="rounded-circle img-thumbnail avatar-xl mt-1" alt="avatar" height={96} width={96} /> : <div className="avatar-xl mx-auto mt-1">
