...
const RequestedBy = ({
  ...
  return <>
      <Link to="" className="text-dark">
        <img src={row.original.requested_by.image} alt="avatar" title="contact-img" className="avatar-sm rounded-circle img-thumbnail" height={36} width={36} />
...
const AssigneeColumn = ({
  ...
  return <>
      <Link to="">
        <img src={row.original.assignee} alt="avatar" title="contact-img" className="avatar-sm rounded-circle img-thumbnail" height={36} width={36} />
      </Link>
    </>;
};
