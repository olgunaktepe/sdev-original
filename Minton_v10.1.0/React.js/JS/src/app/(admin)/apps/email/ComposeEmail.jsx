...
const ComposeEmail = ({
  ...
  return <Modal show={isOpen} onHide={toggleComposeModal} centered>
      ...
      <Modal.Body className="p-3">
        <VerticalForm onSubmit={() => {}} resolver={schemaResolver}>
          <FormInput label="To" type="email" name="to" placeholder="Example@email.com" containerClass={"mb-2"} />
          <FormInput label="Subject" type="text" name="subject" placeholder="Your subject" containerClass={"mb-2"} />
          <div className="mb-2">
