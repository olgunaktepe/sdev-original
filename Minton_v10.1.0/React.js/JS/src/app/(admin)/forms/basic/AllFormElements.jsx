...
import { Row, Col, Form, FloatingLabel, InputGroup, Button, Dropdown, Card, CardBody } from "react-bootstrap";
              ...
              <div className="p-2">
                <Form onSubmit={handleSubmit(() => {})}>
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="text" name="textInput" register={register} key="text" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="email" name="email" placeholder="Email" register={register} key="email" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="password" name="password" endIcon={false} register={register} key="password" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="password" name="password" placeholder="password placeholder" register={register} key="password" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="text" name="placeholder" placeholder="placeholder" register={register} key="placeholder" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="textarea" name="textarea" rows={5} register={register} key="textarea" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="text" name="text1" id="text1" placeholder="Readonly value" readOnly register={register} key="text1" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="text" name="text2" id="text2" placeholder="Disabled value" disabled containerClass={"mb-3"} register={register} key="text2" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="text" name="statictext" className="form-control-plaintext" register={register} key="statictext" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <Form.Control type="text" name="text3" id="text3" placeholder="Helping text" />
                      <Form.Text>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput name="select" type="select" className="form-select" register={register} key="select" errors={errors} control={control}>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput name="selectMulti" type="select" multiple className="form-select" register={register} key="selectMulti" errors={errors} control={control}>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="file" name="file" register={register} key="file" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="date" name="date" register={register} key="date" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="month" name="month" register={register} key="month" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="time" name="time" register={register} key="time" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="week" name="week" register={register} key="week" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="number" name="number" placeholder="number placeholder" register={register} key="number" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="url" name="url" register={register} key="url" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="search" name="search" register={register} key="search" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="tel" name="tel" register={register} key="tel" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
                  ...
                  <Form.Group as={Row} className="mb-2">
                    ...
                    <Col md={10}>
                      <FormInput type="color" name="color" className="w-100" placeholder="color placeholder" register={register} key="color" errors={errors} control={control} />
                    </Col>
                  </Form.Group>
...
const Switches = () => {
  return <Fragment>
      ...
      <Form>
        ...
        <Form.Check type="switch" label="Checked switch checkbox input" id="custom-switch2" defaultChecked={true} />

        <Form.Check disabled type="switch" label="Disabled switch checkbox input" id="custom-switch3" />

        <Form.Check disabled type="switch" label="Disabled checked switch checkbox input" id="custom-switch4" defaultChecked={true} />
      </Form>
    </Fragment>;
};
...
const CustomRadios = () => {
  return <>
      ...
      <Form.Check type="radio" id="default-radio2" name="customRadio" label=" Default checked radio" defaultChecked={true} />
    </>;
};
const InputSizes = () => {
  return <Card>
            ...
            <Form.Group as={Row} className="mb-2">
              ...
              <Col md={10}>
                <InputGroup className="mb-3">
                  <Dropdown>
                    <Dropdown.Toggle variant="primary" id="dropdown-basic" className="waves-effect waves-light">
      ...
      <CardBody>
        ...
        <Form onSubmit={e => e.preventDefault()}>
          ...
          <Form.Group className="mb-2">
            ...
            <Form.Control type="password" name="password" id="examplePassword2" placeholder="password placeholder" defaultValue="12345" />
          </Form.Group>
  ...
  return <>
      <Card>
        <CardBody>
          ...
          <p className="sub-header">
            You may also swap <code>.row</code> for <code>.row</code>, a
            variation of our standard grid row that overrides the default column
