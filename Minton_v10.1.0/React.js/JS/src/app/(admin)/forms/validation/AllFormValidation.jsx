        ...
        <CardBody>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              <Form.Check id="validation-check" required label="Agree to terms and conditions" feedback="You must agree before submitting." />
            </Form.Group>
...
const BasicForm = () => {
  ...
  const schemaResolver = yupResolver(yup.object().shape({
    ...
    confirmpassword: yup.string().oneOf([yup.ref("password")], "Passwords don't match").required("This value is required."),
  ...
  return <Card>
      <CardBody>
        ...
        username: "test"
          ...
          <FormInput label={"Username"} type="text" name="username" placeholder="Enter your name" containerClass={"mb-2"} />
          <FormInput label={"Email address"} type="email" name="email" placeholder="Enter email" containerClass={"mb-2"} />
          <FormInput label={"Password"} type="password" name="password" placeholder="Password" endIcon={false} containerClass={"mb-2"} />
          <FormInput label={"Confirm Password"} type="password" name="confirmpassword" placeholder="Password" endIcon={false} containerClass={"mb-2"} />
...
const HorizontalForm = () => {
  ...
  const schemaResolver2 = yupResolver(yup.object().shape({
    ...
    confirmPassword2: yup.string().oneOf([yup.ref("password")], "Passwords don't match").required("This value is required."),
      ...
      <CardBody>
        ...
        <form name="chat-form" id="chat-form" onSubmit={handleSubmit(() => {})}>
          <Form.Group as={Row} className="mb-2">
            ...
            <Col md={7}>
              <FormInput type="email" name="email2" placeholder="Email" register={register} key="email2" errors={errors} control={control} />
            </Col>
          </Form.Group>
          <Form.Group as={Row} className="mb-2">
            <Form.Label column md={4}>
            ...
            <Col md={7}>
              <FormInput type="password" name="password2" placeholder="Password" register={register} key="password2" endIcon={false} errors={errors} control={control} />
            </Col>
          </Form.Group>
          <Form.Group as={Row} className="mb-2">
            <Form.Label column md={4}>
            ...
            <Col md={7}>
              <FormInput type="password" name="confirmPassword2" placeholder="Password" register={register} key="confirmPassword2" endIcon={false} errors={errors} control={control} />
            </Col>
          </Form.Group>
          <Form.Group as={Row} className="mb-2">
            <Form.Label column md={4}>
            ...
            <Col md={7}>
              <FormInput type="url" name="webSite" placeholder="URL" register={register} key="webSite" errors={errors} control={control} />
            </Col>
          </Form.Group>
          <Form.Group as={Row} className="mb-2" controlId="horizontalCheck">
            <Col xs={8} className="offset-4">
              <FormInput label={"Remember me"} type="checkbox" name="horizontalCheck" register={register} key="horizontalCheck" errors={errors} control={control} />
            </Col>
          </Form.Group>
...
const ValidationTypes = () => {
  ...
  */
  const schemaResolver3 = yupResolver(yup.object().shape({
    ...
    equalTo2: yup.string().oneOf([yup.ref("equalTo1")], "This value should be the same.").required("This value is required."),
  ...
  return <Card>
      <CardBody>
        ...
        <VerticalForm onSubmit={() => {}} resolver={schemaResolver3}>
          <FormInput label={"Required"} type="text" name="requiredInput" placeholder="Type Something" containerClass={"mb-2"} />
          <FormInput label={"Equal To"} type="password" name="equalTo1" placeholder="Password" endIcon={false} />
          <FormInput type="password" name="equalTo2" placeholder="Re-Type Password" endIcon={false} containerClass={"mt-1 mb-2"} />

          <FormInput label={"E-Mail"} type="email" name="email" placeholder="Enter a valid e-mail" containerClass={"mb-2"} />
          <FormInput label={"URL"} type="url" name="url" placeholder="URL" containerClass={"mb-2"} />
          <FormInput label={"Digits"} type="text" name="digits" placeholder="Enter only digits" containerClass={"mb-2"} />
          <FormInput label={"Number"} type="text" name="numberInput" placeholder="Enter only numbers" containerClass={"mb-2"} />
          <FormInput label={"Alphanumeric"} type="text" name="alphaNumeric" containerClass={"mb-2"} placeholder="Enter alphanumeric value" />
...
const RangeValidation = () => {
  ...
  return <Card>
      <CardBody>
        ...
        <VerticalForm onSubmit={() => {}} resolver={schemaResolver4}>
          <FormInput label={"Min Length"} type="text" name="minLenInput" placeholder="Min 6 chars." containerClass={"mb-2"} />
          <FormInput label={"Max Length"} type="text" name="maxLenInput" placeholder="Max 6 chars" containerClass={"mb-2"} />
          <FormInput label={"Range Length"} type="text" name="rangeLenInput" placeholder="Text between 5 - 10 chars length" containerClass={"mb-2"} />
          <FormInput label={"Min Value"} type="text" name="minValueInput" placeholder="Min value is 6" containerClass={"mb-2"} />
          <FormInput label={"Max Value"} type="text" name="maxValueInput" placeholder="Max value is 6" containerClass={"mb-2"} />
          <FormInput label={"Range Value"} type="text" name="rangeValueInput" placeholder="Number between 6 - 100" containerClass={"mb-2"} />
          <FormInput label={"Regular Exp"} type="text" name="regEx" placeholder="Hex. Color" containerClass={"mb-2"} />
