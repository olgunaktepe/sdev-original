                    ...
                    <Card>
                        <CardBody>
                            ...
                            <div className="pt-3">
                                <Row>
                                    <Col md={4}>
                                        <SparkLineChart sparkLineChartData={sparkLineData1} colors={["#3bafda"]} titleText="$424,652" subTitleText="Total Sales" />
                                    </Col>
                                    <Col md={4}>
                                        <SparkLineChart sparkLineChartData={sparkLineData2} colors={["#DCE6EC"]} titleText="$235,312" subTitleText="Expenses" />
                                    </Col>
                                    <Col md={4}>
                                        <SparkLineChart sparkLineChartData={sparkLineData3} colors={["#1abc9c"]} titleText="$135,965" subTitleText="Profits" />
                                    </Col>
                                </Row>
                            </div>
                        </CardBody>
