...
import { Button, Card, CardBody, Col, Offcanvas, Row } from "react-bootstrap";
        ...
        <Card>
          <CardBody>
            ...
            <div className="button-list">
              {(options || []).map((props, idx) => <OffCanvasWithBackdrop key={idx} name={props.name} scroll={props.scroll} backdrop={props.backdrop} />)}
            </div>
          </CardBody>
        </Card>
      </Col>
      ...
      <Col xl={6}>
        <Card>
          <CardBody>
            ...
            <div className="button-list">
              {(placementOptions || []).map((option, index) => <OffcanvasPlacement key={index} placement={option.placement} name={option.name} />)}
            </div>
          </CardBody>
        </Card>
      </Col>
