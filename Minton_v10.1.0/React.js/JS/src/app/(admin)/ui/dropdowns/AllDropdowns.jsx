...
const ColorVariantButtonDropdown = () => {
  return <div className="mt-5">
      ...
      return <Dropdown key={index} as={ButtonGroup} className="mt-2 me-1">
...
const DropdownWithText = () => {
  return <div className="mt-5">
      ...
      <Dropdown as={ButtonGroup} className="mt-2">
        ...
        <Dropdown.Menu className="p-3 text-muted" style={{
        maxWidth: "200px"
      }}>
