...
const OutlineButtons = () => {
  return <>
      ...
      <div className="button-list">
        {(buttonVariants || []).map((button, index) => {
        return <Button key={index} variant={"outline-" + button.color} className="waves-effect waves-light">
              {button.name}
            </Button>;
      })}
      </div>
...
const OutlineRoundedButtons = () => {
  return <>
      ...
      <div className="button-list">
        {(buttonVariants || []).map((button, index) => {
        return <Button key={index} variant={"outline-" + button.color} className="rounded-pill">
              {button.name}
            </Button>;
      })}
      </div>
...
const SoftButtons = () => {
  return <>
      ...
      <div className="button-list">
        {(buttonVariants || []).map((button, index) => {
        return <Button key={index} variant={"soft-" + button.color} className="waves-effect waves-light">
              {button.name}
            </Button>;
      })}
      </div>
...
const OutlineSoftButtons = () => {
  return <>
      ...
      <div className="button-list">
        {(buttonVariants || []).map((button, index) => {
        return <Button key={index} variant={"soft-" + button.color} className="rounded-pill waves-effect waves-light">
              {button.name}
            </Button>;
      })}
      </div>
...
const BorderedButtons = () => {
  return <>
      ...
      <p className="sub-header">
        Use a classes <code>.btn-bordered</code> with <code>.btn-*</code> to
        quickly create a bordered buttons.
      </p>

      <div className="button-list">
        {(buttonVariants || []).map((button, index) => {
        return <Button key={index} variant={button.color} className="btn-bordered waves-effect waves-light">
              {button.name}
            </Button>;
      })}
      </div>
...
const RoundedBorderedButtons = () => {
  return <>
      ...
      <div className="button-list">
        {(buttonVariants || []).map((button, index) => {
        return <Button key={index} variant={button.color} className="btn-bordered rounded-pill waves-effect waves-light">
              {button.name}
            </Button>;
      })}
      </div>
...
const ButtonsWithLabels = () => {
  ...
  return <>
      ...
      <div className="button-list">
        ...
        return <Button key={index} variant={button.variant} className="waves-effect waves-light">
...
const RoundedButtonsWithLabels = () => {
  ...
  return <>
      ...
      <div className="button-list">
        {(buttons || []).map((button, index) => {
        return <Button key={index} variant={button.variant} className="rounded-pill waves-effect waves-light">
              <span className="btn-label">
                <i className={button.icon}></i>
              </span>
              {button.name}
