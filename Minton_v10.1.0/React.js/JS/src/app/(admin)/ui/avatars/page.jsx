...
const RoundedCircle = ({
  ...
  return <Col sm={6} className="col-md">
      <div className="mt-3">
        <img src={avatar3} alt="" className={classNames("img-fluid", "rounded-circle", "avatar-" + className)} height={size} width={size} />
        <p className="mb-0">
          ...
          <Card>
            <CardBody>
              ...
              <Row>
                ...
                <Col sm={6} className="col-md">
                  <div className="mt-3">
                    <img src={avatar3} alt="" className="img-fluid avatar-sm rounded mt-2" height={36} width={36} />
                    <p className="mb-0">
                      <code>.avatar-sm</code>
                    </p>
                  </div>
                ...
                <Col sm={6} className="col-md">
                  <div className="mt-3">
                    <img src={avatar4} alt="" className="img-fluid avatar-md rounded" height={56} width={56} />
                    <p className="mb-0">
                      <code>.avatar-md</code>
                    </p>
                  </div>
                ...
                <Col sm={6} className="col-md">
                  <div className="mt-3">
                    <img src={avatar5} alt="" className="img-fluid avatar-lg rounded" height={72} width={72} />
                    <p className="mb-0">
                      <code>.avatar-lg</code>
                    </p>
                  </div>
                ...
                <Col sm={6} className="col-md">
                  <div className="mt-3">
                    <img src={avatar6} alt="" className="img-fluid avatar-xl rounded" height={96} width={96} />
                    <p className="mb-0">
                      <code>.avatar-xl</code>
                    </p>
                  </div>
            ...
            <CardBody>
              ...
              <Row>
                ...
                <Col sm={2} className=" text-center">
                  <img src={avatar5} alt="" className="img-fluid rounded" width={120} height={120} />
                  <p className="mb-0">
                    <code>.rounded</code>
                  </p>
                </Col>
                ...
                <Col sm={2} className=" text-center">
                  <img src={avatar7} alt="" className="img-fluid rounded-circle" width={120} height={120} />
                  <p className="mb-0">
                ...
                <Col sm={2}>
                  <img src={img2} alt="" className="img-fluid img-thumbnail" width={200} height={136} />
                  <p className="mb-0">
                ...
                <Col sm={2}>
                  <img src={avatar8} alt="" className="img-fluid rounded-circle img-thumbnail" width={120} height={120} />
                  <p className="mb-0">
