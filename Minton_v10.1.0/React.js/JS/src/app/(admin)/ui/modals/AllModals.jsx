...
import { Accordion, Button, Card, CardBody, CardHeader, Col, Modal, Row } from "react-bootstrap";
...
const ModalSizes = () => {
  ...
  /**
   * open modal with full screen
   */
  const openModalWithFullScreen = () => {
    setFullScreen(true);
      ...
      <Card>
        <CardBody>
          ...
          <div className="button-list">
            ...
            <Button variant="purple" onClick={() => openModalWithFullScreen()}>
              Full screen Modal
            </Button>
            <Button variant="pink" onClick={() => openModalWithClass("modal-full-width")}>
              Full width Modal
            </Button>
          ...
          {/* fullScreen modal */}
          <Modal show={fullScreenModal} onHide={toggleFullScreenModal} fullscreen={fullscreen}>
            <Modal.Header onHide={toggleFullScreenModal} closeButton>
              <h4 className="modal-title">Modal Heading</h4>
            </Modal.Header>
            <Modal.Body>
              <h6>Text in a modal</h6>
            ...
            <Modal.Footer>
              <Button variant="light" onClick={toggleFullScreenModal}>
                Close
              </Button>{" "}
              <Button variant="primary" onClick={toggleFullScreenModal}>
                Save changes
              </Button>
            </Modal.Footer>
          </Modal>
  ...
  return <>
      <Card>
        <CardBody>
          ...
          <p className="sub-header">Examples of Static backdrop.</p>
          ...
          <div className={classNames("modal-filled", "bg-" + className)}>
            <Modal.Body className="p-4">
              <div className="text-center">
                ...
                <button type="button" onClick={toggle} className="btn btn-light my-2">
                  Continue
                </button>
              </div>
            </Modal.Body>
...
const CustomModals = () => {
  ...
  const [accordionModal, setAccordionModal] = useState(false);
      ...
      <Card>
        <CardBody>
          ...
          <Modal show={responsiveModal} onHide={toggleResponsiveModal}>
              ...
              <Row>
                ...
                <Col md={4}>
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="field-5" placeholder="United States" required />
                  </div>
                </Col>
                <Col md={4}>
                  <div className="mb-3">
              ...
              <Row>
                <Col md={12}>
                  <div className="">
                    ...
                    <textarea className="form-control" id="field-7" placeholder="Write something about yourself" required></textarea>
                  </div>
                </Col>
              </Row>
            </Modal.Body>
            ...
            <Modal.Footer>
              <button type="button" className="btn btn-secondary waves-effect" onClick={toggleResponsiveModal}>
                Close
              </button>
