...
const Widgets = () => {
  return <>
      ...
      <Row>
        <Col xl={3} md={6}>
          <ProfileCard avatar={user1} name="Chadengle" email="coderthemes@gmail.com" role="Admin" variant="warning" />
        </Col>
        <Col xl={3} md={6}>
          <ProfileCard avatar={user2} name="Tomaslau" email="coderthemes@gmail.com" role="User" variant="success" />
        </Col>
        <Col xl={3} md={6}>
          <ProfileCard avatar={user3} name="Stillnotdavid" email="coderthemes@gmail.com" role="Admin" variant="pink" />
        </Col>
        <Col xl={3} md={6}>
          <ProfileCard avatar={user4} name="Arashasghari" email="coderthemes@gmail.com" role="User" variant="info" />
        </Col>
      </Row>
