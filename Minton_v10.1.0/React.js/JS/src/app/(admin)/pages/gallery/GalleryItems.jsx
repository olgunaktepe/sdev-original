  ...
  return <>
        ...
        <Col xs={12}>
          <div className="text-center filter-menu">
            <Link to="" className={classNames("filter-menu-item", "me-1", {
            active: category === "all"
      ...
      <Row className="filterable-content position-relative">
        ...
        return <Col sm={6} xl={3} className="filter-item all illustrator" key={index}>
              <div className="gal-box">
                <Link to="" className="image-popup" onClick={openLightbox}>
                ...
                <div className="gall-info">
                  ...
                  <Link to="">
                    <img src={item.avatar} alt="user-img" className="rounded-circle" height={24} width={24} />
