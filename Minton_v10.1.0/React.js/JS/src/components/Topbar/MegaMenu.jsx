...
const MegaMenu = ({
  ...
  return <Dropdown show={dropdownOpen} onToggle={toggleDropdown} className="position-static">
      <Dropdown.Toggle id="dropdown-megamenu" as="a" onClick={toggleDropdown} className={classNames("nav-link", "waves-effect", "waves-light", {
      show: dropdownOpen
    })}>
