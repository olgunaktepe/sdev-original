...
const Chats = ({
  ...
  return <>
      ...
      <div className="p-2">
        ...
        return <Link to='' key={index} className="text-reset notification-item">
              <div className="d-flex align-items-start noti-user-item">
                <div className="position-relative me-2">
                  <span className={classNames("user-status", item.userStatus)}></span>
                  <img src={item.avatar} className="rounded-circle avatar-sm" alt="chat avatar" />
                </div>
      ...
      <div className="p-2 pb-4">
        ...
        return <Link to='' key={index} className="text-reset notification-item">
                <div className="d-flex align-items-start noti-user-item">
                  <div className="position-relative me-2">
                    <span className={classNames("user-status", item.userStatus)}></span>
                    <img src={item.avatar} className="rounded-circle avatar-sm" alt="user avatar" />
                  </div>
                  <div className="overflow-hidden">
                    <h6 className="mt-0 mb-1 font-14">{item.userName}</h6>
                    <div className="font-13 text-muted">
