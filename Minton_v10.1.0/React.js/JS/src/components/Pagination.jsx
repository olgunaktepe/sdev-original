...
const Pagination = ({
   ...
   * get filter pages
   */
  const filterPages = useCallback((visiblePages, _totalPages) => {
  ...
  return <>
      <div className="d-lg-flex align-items-center text-center pb-1">
        ...
        <ul className="pagination pagination-rounded d-inline-flex ms-auto align-item-center mb-0">
          <li key="prevpage" className={classNames("page-item", "paginate_button", "previous", {
          ...
          return array[index - 1] + 1 < page ? <React.Fragment key={page}>
                <li className="page-item disabled d-none d-xl-inline-block">
                  <Link to="" className="page-link">
                    ...
                  </Link>
                </li>
                <li className={classNames("page-item", "d-none", "d-xl-inline-block", {
              ...
              </React.Fragment> : <li key={page} className={classNames("page-item", "d-none", "d-xl-inline-block", {
            active: activePage === page
          })} onClick={() => changePage(page)}>
                <Link to="" className="page-link">
                  {page}
          ...
          <li key="nextpage" className={classNames("page-item", "paginate_button", "next", {
