...
$REQUEST->request = preg_replace('/\/$/','',$REQUEST->request);
...
if($REQUEST->type == 'util'){
	...
	foreach($pages as $page){			
		...
		if(file_exists($script)){ include_once $script; }
					
		$script = $_REQUEST['_admin'] . $GLOBALS['system']['script_path'] . "/$page/common.php";
		if(file_exists($script)){ include_once $script; }
	}	
