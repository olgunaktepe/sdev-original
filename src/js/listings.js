$(document).ready(function () {
    var script = "ajax/php/listings.php";
    var selectors = {
        ...
        templates: {                    	
        	item			: '#template-listings-item',
        	summary			: '#template-summary',
        	updates			: 'ajax/template/listings/_updates.phtml',
    ...
    function bind() {
		...
		container.on('click',selectors.view,function(e){ e.preventDefault(); view($(this)); });
