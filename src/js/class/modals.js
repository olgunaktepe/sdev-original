var Modal = Class.create({
	...
	create: function(){
		var $this = this;
		this.modal = $('<div class="modal fade aaaa" tabindex="-1" role="dialog" aria-hidden="true" style="overflow: auto;!important">\
		...
		if($.defined(this.options.size))
			this.modal.find('.modal-dialog').css('max-width',this.options.size);
